...
export class PaletteController extends BaseScriptComponent {
	...
	@input
	@hint("Path to Encoder_PigmentMix child within colorGamutObject")
	pigmentEncoderPath: string = "Encoder_PigmentMix";
	...
	private initializeColorGamut(): void {
		...
		if (!this.pigmentEncoderScript) {
			print(
				"PaletteController: No ScriptComponent found on Encoder_PigmentMix"
			);
			return;
		}
