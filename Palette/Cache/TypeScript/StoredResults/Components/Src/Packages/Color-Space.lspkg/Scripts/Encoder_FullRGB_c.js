...
// @input Asset.Material encoderMaterial {"hint":"Material with LAB encoder Code Node (outputs labPos and rgbCol)"}
...
var Module = require("../../../../../Modules/Src/Packages/Color-Space.lspkg/Scripts/Encoder_FullRGB");
Object.setPrototypeOf(script, Module.Encoder_FullRGB.prototype);
script.__initialize();
