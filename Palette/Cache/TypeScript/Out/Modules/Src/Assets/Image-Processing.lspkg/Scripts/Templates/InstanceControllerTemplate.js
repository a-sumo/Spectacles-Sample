...
var __selfType = requireType("./InstanceControllerTemplate");
...
let NewScript = (() => {
    ...
    var NewScript = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.spacing = this.spacing; // Distance between objects
            this.objectList = [];
            ...
            for (let x = 0; x < 2; x++) {
                for (let y = 0; y < 2; y++) {
                    for (let z = 0; z < 2; z++) {
                        ...
                        transform.setLocalPosition(new vec3(x * this.spacing - this.spacing / 2, y * this.spacing - this.spacing / 2, z * this.spacing - this.spacing / 2));
...
//# sourceMappingURL=InstanceControllerTemplate.js.map