...
exports.PaletteProjector = void 0;
var __selfType = requireType("./PaletteProjector");
...
let PaletteProjector = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var PaletteProjector = _classThis = class extends _classSuper {
        constructor() {
            super();
            // ============ INPUTS ============
            this.inputTexture = this.inputTexture;
            this.outputMesh = this.outputMesh;
            this.outputMaterial = this.outputMaterial;
        ...
        mixPigments(concentrations) {
            ...
            const computeR = (kv, sv) => {
                if (sv === 0)
                    return 0;
                const ks = kv / sv;
                return Math.max(0, Math.min(1, 1 + ks - Math.sqrt(ks * ks + 2 * ks)));
            };
            return new vec3(computeR(k.x, s.x), computeR(k.y, s.y), computeR(k.z, s.z));
        }
        // ============ BUILD GAMUT ============
        buildGamut() {
            this.gamut = [];
        ...
        extractPalette(texture) {
            ...
            const provider = tempTex.control;
            ...
            for (let i = 0; i < sampleCount; i++) {
                ...
                sampled.push(new vec3(pixels[idx] / 255, pixels[idx + 1] / 255, pixels[idx + 2] / 255));
            }
            // K-means clustering
        ...
        applyToMesh(meshVisual, inputTex) {
        ...
        process(texture) {
            ...
            if (this.outputMesh && this.outputMaterial) {
                const rmv = this.outputMesh.getComponent("Component.RenderMeshVisual");
                if (rmv) {
    ...
    __setFunctionName(_classThis, "PaletteProjector");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PaletteProjector = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PaletteProjector = _classThis;
})();
exports.PaletteProjector = PaletteProjector;
//# sourceMappingURL=PaletteProjector.js.map