...
exports.Encoder_PigmentMixHiRes = void 0;
var __selfType = requireType("./Encoder_PigmentMixHiRes");
...
// Encoder_PigmentMixHiRes.ts
// High-resolution version of Encoder_PigmentMix for detailed gamut visualization
let Encoder_PigmentMixHiRes = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var Encoder_PigmentMixHiRes = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        onAwake() {
            ...
            this.pigmentTexture = ProceduralTextureProvider.createWithFormat(Encoder_PigmentMixHiRes.NUM_PIGMENTS, 1, TextureFormat.RGBA8Unorm);
            ...
            this.material.mainPass.numPigments = Encoder_PigmentMixHiRes.NUM_PIGMENTS;
            this.material.mainPass.texWidth = Encoder_PigmentMixHiRes.NUM_PIGMENTS;
        ...
        updatePigmentTexture() {
            const pixels = new Uint8Array(Encoder_PigmentMixHiRes.NUM_PIGMENTS * 4);
            const pigments = [
                this.pig0Color,
                this.pig1Color,
                this.pig2Color,
            ...
            for (let i = 0; i < Encoder_PigmentMixHiRes.NUM_PIGMENTS; i++) {
                const idx = i * 4;
            ...
            this.pigmentTexture.control.setPixels(0, 0, Encoder_PigmentMixHiRes.NUM_PIGMENTS, 1, pixels);
        }
        ...
        assignToVFX() {
            if (this.vfxComponent && this.vfxComponent.asset) {
                ...
                props["labLA"] = this.rtLabLA;
                props["labBV"] = this.rtLabBV;
                // RGB color
                props["colorMap"] = this.rtColor;
                // Mix info (optional)
                props["mixInfo"] = this.rtMixInfo;
                // Parameters
        ...
        logGamutInfo() {
            const n = Encoder_PigmentMixHiRes.NUM_PIGMENTS;
        ...
        static unpack16(hi, lo) {
            return (hi * 256 + lo) / 65535;
        }
        /** Unpack signed 16-bit value (for debugging) */
        static unpackSigned16(hi, lo, range) {
            const normalized = Encoder_PigmentMixHiRes.unpack16(hi, lo);
            return normalized * (2 * range) - range;
        }
    };
    __setFunctionName(_classThis, "Encoder_PigmentMixHiRes");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        Encoder_PigmentMixHiRes = _classThis = _classDescriptor.value;
    ...
    return Encoder_PigmentMixHiRes = _classThis;
})();
exports.Encoder_PigmentMixHiRes = Encoder_PigmentMixHiRes;
//# sourceMappingURL=Encoder_PigmentMixHiRes.js.map