...
//sampler sampler testMapSmpSC 0:36
//texture texture2D renderTarget0 0:1:0:23
//texture texture2D renderTarget1 0:2:0:24
//texture texture2D renderTarget2 0:3:0:25
//texture texture2D renderTarget3 0:4:0:26
//texture texture2D testMap 0:21:0:36
//ubo int UserUniforms 0:37:7536 {
//float4 sc_Time 1376
...
//float3x3 testMapTransform 7440
//float4 testMapUvMinMax 7488
//float4 testMapBorderColor 7504
//float texSize 7520
//float scale 7524
//float Port_Value_N013 7528
//}
//spec_const bool SC_USE_CLAMP_TO_BORDER_testMap 0 0
//spec_const bool SC_USE_UV_MIN_MAX_testMap 1 0
//spec_const bool SC_USE_UV_TRANSFORM_testMap 2 0
//spec_const bool renderTarget0HasSwappedViews 3 0
//spec_const bool renderTarget1HasSwappedViews 4 0
//spec_const bool renderTarget2HasSwappedViews 5 0
//spec_const bool renderTarget3HasSwappedViews 6 0
//spec_const bool testMapHasSwappedViews 7 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_testMap 8 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_testMap 9 -1
//spec_const int renderTarget0Layout 10 0
//spec_const int renderTarget1Layout 11 0
//spec_const int renderTarget2Layout 12 0
//spec_const int renderTarget3Layout 13 0
...
//spec_const int testMapLayout 17 0
//SG_REFLECTION_END
constant bool SC_USE_CLAMP_TO_BORDER_testMap [[function_constant(0)]];
constant bool SC_USE_CLAMP_TO_BORDER_testMap_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_testMap) ? SC_USE_CLAMP_TO_BORDER_testMap : false;
constant bool SC_USE_UV_MIN_MAX_testMap [[function_constant(1)]];
constant bool SC_USE_UV_MIN_MAX_testMap_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_testMap) ? SC_USE_UV_MIN_MAX_testMap : false;
constant bool SC_USE_UV_TRANSFORM_testMap [[function_constant(2)]];
constant bool SC_USE_UV_TRANSFORM_testMap_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_testMap) ? SC_USE_UV_TRANSFORM_testMap : false;
constant bool renderTarget0HasSwappedViews [[function_constant(3)]];
...
constant bool renderTarget1HasSwappedViews [[function_constant(4)]];
...
constant bool renderTarget2HasSwappedViews [[function_constant(5)]];
...
constant bool renderTarget3HasSwappedViews [[function_constant(6)]];
...
constant bool testMapHasSwappedViews [[function_constant(7)]];
constant bool testMapHasSwappedViews_tmp = is_function_constant_defined(testMapHasSwappedViews) ? testMapHasSwappedViews : false;
constant int SC_SOFTWARE_WRAP_MODE_U_testMap [[function_constant(8)]];
constant int SC_SOFTWARE_WRAP_MODE_U_testMap_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_testMap) ? SC_SOFTWARE_WRAP_MODE_U_testMap : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_testMap [[function_constant(9)]];
constant int SC_SOFTWARE_WRAP_MODE_V_testMap_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_testMap) ? SC_SOFTWARE_WRAP_MODE_V_testMap : -1;
constant int renderTarget0Layout [[function_constant(10)]];
constant int renderTarget0Layout_tmp = is_function_constant_defined(renderTarget0Layout) ? renderTarget0Layout : 0;
constant int renderTarget1Layout [[function_constant(11)]];
constant int renderTarget1Layout_tmp = is_function_constant_defined(renderTarget1Layout) ? renderTarget1Layout : 0;
constant int renderTarget2Layout [[function_constant(12)]];
constant int renderTarget2Layout_tmp = is_function_constant_defined(renderTarget2Layout) ? renderTarget2Layout : 0;
constant int renderTarget3Layout [[function_constant(13)]];
constant int renderTarget3Layout_tmp = is_function_constant_defined(renderTarget3Layout) ? renderTarget3Layout : 0;
constant int sc_ShaderCacheConstant [[function_constant(14)]];
constant int sc_ShaderCacheConstant_tmp = is_function_constant_defined(sc_ShaderCacheConstant) ? sc_ShaderCacheConstant : 0;
constant int sc_StereoRenderingMode [[function_constant(15)]];
constant int sc_StereoRenderingMode_tmp = is_function_constant_defined(sc_StereoRenderingMode) ? sc_StereoRenderingMode : 0;
constant int sc_StereoRendering_IsClipDistanceEnabled [[function_constant(16)]];
constant int sc_StereoRendering_IsClipDistanceEnabled_tmp = is_function_constant_defined(sc_StereoRendering_IsClipDistanceEnabled) ? sc_StereoRendering_IsClipDistanceEnabled : 0;
constant int testMapLayout [[function_constant(17)]];
constant int testMapLayout_tmp = is_function_constant_defined(testMapLayout) ? testMapLayout : 0;
...
float4 testMapDims;
float4 testMapView;
float3x3 testMapTransform;
float4 testMapUvMinMax;
float4 testMapBorderColor;
float texSize;
float scale;
float Port_Value_N013;
};
struct sc_Set0
{
...
texture2d<float> testMap [[id(21)]];
sampler renderTarget0SmpSC [[id(23)]];
sampler renderTarget1SmpSC [[id(24)]];
sampler renderTarget2SmpSC [[id(25)]];
sampler renderTarget3SmpSC [[id(26)]];
sampler testMapSmpSC [[id(36)]];
...
gParticle.Size=(*sc_set0.UserUniforms).Port_Value_N013;
...
float param_3=(*sc_set0.UserUniforms).scale;
Output_N10=param_3;
float3 particlePosition_N2=float3(0.0);
float4 particleColor_N2=float4(0.0);
float param_4=Output_N9;
float param_5=Output_N10;
float3 param_6=float3(0.0);
float4 param_7=float4(0.0);
N2_texSize=param_4;
N2_scale=param_5;
float l9_13=gParticle.Ratio1DPerCopy;
float l9_14=l9_13;
float l9_15=N2_texSize*N2_texSize;
float l9_16=floor((l9_14*(l9_15-1.0))+0.5);
float l9_17=floor(l9_16/N2_texSize);
float l9_18=mod(l9_16,N2_texSize);
float l9_19=(l9_18+0.5)/N2_texSize;
float l9_20=(l9_17+0.5)/N2_texSize;
float2 l9_21=float2(l9_19,l9_20);
float4 l9_22=float4(0.0);
int l9_23;
if ((int(testMapHasSwappedViews_tmp)!=0))
{
int l9_24=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_28=l9_23;
int l9_29=testMapLayout_tmp;
int l9_30=l9_28;
float2 l9_31=l9_21;
bool l9_32=(int(SC_USE_UV_TRANSFORM_testMap_tmp)!=0);
float3x3 l9_33=(*sc_set0.UserUniforms).testMapTransform;
int2 l9_34=int2(SC_SOFTWARE_WRAP_MODE_U_testMap_tmp,SC_SOFTWARE_WRAP_MODE_V_testMap_tmp);
bool l9_35=(int(SC_USE_UV_MIN_MAX_testMap_tmp)!=0);
float4 l9_36=(*sc_set0.UserUniforms).testMapUvMinMax;
bool l9_37=(int(SC_USE_CLAMP_TO_BORDER_testMap_tmp)!=0);
float4 l9_38=(*sc_set0.UserUniforms).testMapBorderColor;
float l9_39=0.0;
...
float4 l9_106=sc_set0.testMap.sample(sc_set0.testMapSmpSC,l9_105.xy,level(l9_99));
...
N2_particlePosition=float3(l9_111-0.5,l9_20-0.5,0.0)*N2_scale;
N2_particleColor=float4(l9_111,1.0-l9_111,0.0,1.0);
param_6=N2_particlePosition;
param_7=N2_particleColor;
particlePosition_N2=param_6;
particleColor_N2=param_7;
...
float4 l9_112=param_9;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_113=dot(l9_112,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_114=l9_113;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_114;
}
}
float4 l9_115=float4(param_9.x,-param_9.y,(param_9.z*0.5)+(param_9.w*0.5),param_9.w);
out.gl_Position=l9_115;
return out;
}
float l9_116;
...
{
l9_116=gParticle.Force.x;
}
gParticle.Force.x=l9_116;
float l9_117;
...
{
l9_117=gParticle.Force.y;
}
gParticle.Force.y=l9_117;
float l9_118;
...
{
l9_118=gParticle.Force.z;
}
gParticle.Force.z=l9_118;
...
{
l9_119=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_119;
float l9_120;
...
{
l9_120=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_120;
float l9_121;
...
{
l9_121=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_121;
...
float4 l9_124=param_10;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_125=dot(l9_124,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_126=l9_125;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_126;
}
}
float4 l9_127=float4(param_10.x,-param_10.y,(param_10.z*0.5)+(param_10.w*0.5),param_10.w);
out.gl_Position=l9_127;
...
float4 l9_131=float4(param_11.x,-param_11.y,(param_11.z*0.5)+(param_11.w*0.5),param_11.w);
