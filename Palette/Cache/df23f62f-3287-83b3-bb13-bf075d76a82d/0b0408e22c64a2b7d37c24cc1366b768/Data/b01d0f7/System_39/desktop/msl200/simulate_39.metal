...
//sampler sampler labBVSmpSC 0:26
//sampler sampler labLASmpSC 0:27
...
//texture texture2D labBV 0:2:0:26
//texture texture2D labLA 0:3:0:27
...
//float3x3 labLATransform 7440
//float4 labLAUvMinMax 7488
//float4 labLABorderColor 7504
//float3x3 labBVTransform 7568
//float4 labBVUvMinMax 7616
//float4 labBVBorderColor 7632
//float3x3 colorMapTransform 7696
//float4 colorMapUvMinMax 7744
//float4 colorMapBorderColor 7760
//float texSize 7776
//float Port_Input1_N014 7780
//}
//spec_const bool SC_USE_CLAMP_TO_BORDER_colorMap 0 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_labBV 1 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_labLA 2 0
//spec_const bool SC_USE_UV_MIN_MAX_colorMap 3 0
//spec_const bool SC_USE_UV_MIN_MAX_labBV 4 0
//spec_const bool SC_USE_UV_MIN_MAX_labLA 5 0
//spec_const bool SC_USE_UV_TRANSFORM_colorMap 6 0
//spec_const bool SC_USE_UV_TRANSFORM_labBV 7 0
//spec_const bool SC_USE_UV_TRANSFORM_labLA 8 0
//spec_const bool colorMapHasSwappedViews 9 0
//spec_const bool labBVHasSwappedViews 10 0
//spec_const bool labLAHasSwappedViews 11 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_labBV 17 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_labLA 18 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_colorMap 19 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_labBV 20 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_labLA 21 -1
//spec_const int colorMapLayout 22 0
//spec_const int labBVLayout 23 0
//spec_const int labLALayout 24 0
...
constant bool SC_USE_CLAMP_TO_BORDER_labBV [[function_constant(1)]];
constant bool SC_USE_CLAMP_TO_BORDER_labBV_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_labBV) ? SC_USE_CLAMP_TO_BORDER_labBV : false;
constant bool SC_USE_CLAMP_TO_BORDER_labLA [[function_constant(2)]];
constant bool SC_USE_CLAMP_TO_BORDER_labLA_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_labLA) ? SC_USE_CLAMP_TO_BORDER_labLA : false;
...
constant bool SC_USE_UV_MIN_MAX_labBV [[function_constant(4)]];
constant bool SC_USE_UV_MIN_MAX_labBV_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_labBV) ? SC_USE_UV_MIN_MAX_labBV : false;
constant bool SC_USE_UV_MIN_MAX_labLA [[function_constant(5)]];
constant bool SC_USE_UV_MIN_MAX_labLA_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_labLA) ? SC_USE_UV_MIN_MAX_labLA : false;
...
constant bool SC_USE_UV_TRANSFORM_labBV [[function_constant(7)]];
constant bool SC_USE_UV_TRANSFORM_labBV_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_labBV) ? SC_USE_UV_TRANSFORM_labBV : false;
constant bool SC_USE_UV_TRANSFORM_labLA [[function_constant(8)]];
constant bool SC_USE_UV_TRANSFORM_labLA_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_labLA) ? SC_USE_UV_TRANSFORM_labLA : false;
...
constant bool labBVHasSwappedViews [[function_constant(10)]];
constant bool labBVHasSwappedViews_tmp = is_function_constant_defined(labBVHasSwappedViews) ? labBVHasSwappedViews : false;
constant bool labLAHasSwappedViews [[function_constant(11)]];
constant bool labLAHasSwappedViews_tmp = is_function_constant_defined(labLAHasSwappedViews) ? labLAHasSwappedViews : false;
...
constant int SC_SOFTWARE_WRAP_MODE_U_labBV [[function_constant(17)]];
constant int SC_SOFTWARE_WRAP_MODE_U_labBV_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_labBV) ? SC_SOFTWARE_WRAP_MODE_U_labBV : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_labLA [[function_constant(18)]];
constant int SC_SOFTWARE_WRAP_MODE_U_labLA_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_labLA) ? SC_SOFTWARE_WRAP_MODE_U_labLA : -1;
...
constant int SC_SOFTWARE_WRAP_MODE_V_labBV [[function_constant(20)]];
constant int SC_SOFTWARE_WRAP_MODE_V_labBV_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_labBV) ? SC_SOFTWARE_WRAP_MODE_V_labBV : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_labLA [[function_constant(21)]];
constant int SC_SOFTWARE_WRAP_MODE_V_labLA_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_labLA) ? SC_SOFTWARE_WRAP_MODE_V_labLA : -1;
...
constant int labBVLayout [[function_constant(23)]];
constant int labBVLayout_tmp = is_function_constant_defined(labBVLayout) ? labBVLayout : 0;
constant int labLALayout [[function_constant(24)]];
constant int labLALayout_tmp = is_function_constant_defined(labLALayout) ? labLALayout : 0;
...
float4 labLADims;
float4 labLAView;
float3x3 labLATransform;
float4 labLAUvMinMax;
float4 labLABorderColor;
float4 labBVSize;
float4 labBVDims;
float4 labBVView;
float3x3 labBVTransform;
float4 labBVUvMinMax;
float4 labBVBorderColor;
float4 colorMapSize;
float4 colorMapDims;
float4 colorMapView;
...
texture2d<float> labBV [[id(2)]];
texture2d<float> labLA [[id(3)]];
...
sampler labBVSmpSC [[id(26)]];
sampler labLASmpSC [[id(27)]];
...
l9_42=!(UserUniforms.vfxBatchEnable[l9_43/32768]!=0);
}
else
{
l9_42=l9_41;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/32768];
...
int l9_9=gl_InstanceIndex;
float4x4 l9_10=(*sc_set0.UserUniforms).vfxModelMatrix[l9_9/32768];
float3 l9_11=float3(length(l9_10[0].xyz),length(l9_10[1].xyz),length(l9_10[2].xyz));
l9_8=l9_11;
float l9_12=0.0;
l9_12=length(l9_8);
float l9_13=0.0;
l9_13=l9_12*(*sc_set0.UserUniforms).Port_Input1_N014;
gParticle.Size=l9_13;
...
float4 l9_14=param_1;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_15=dot(l9_14,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_16=l9_15;
...
{
out.varClipDistance=l9_16;
}
}
float4 l9_17=float4(param_1.x,-param_1.y,(param_1.z*0.5)+(param_1.w*0.5),param_1.w);
out.gl_Position=l9_17;
return out;
}
float Output_N9=0.0;
float param_2=(*sc_set0.UserUniforms).texSize;
Output_N9=param_2;
float3 Position_N5=float3(0.0);
float3 Rotation_N5=float3(0.0);
float3 Scale_N5=float3(0.0);
int l9_19=gl_InstanceIndex;
float4x4 l9_20=(*sc_set0.UserUniforms).vfxModelMatrix[l9_19/32768];
float3 param_3=l9_20[3].xyz;
float3 param_5=float3(length(l9_20[0].xyz),length(l9_20[1].xyz),length(l9_20[2].xyz));
float3x3 l9_21=float3x3(float3(l9_20[0].xyz/float3(param_5.x)),float3(l9_20[1].xyz/float3(param_5.y)),float3(l9_20[2].xyz/float3(param_5.z)));
float l9_22=sqrt((l9_21[0].x*l9_21[0].x)+(l9_21[1].x*l9_21[1].x));
float3 param_4;
param_4.x=-atan2(l9_21[2].y,l9_21[2].z);
param_4.y=-atan2(-l9_21[2].x,l9_22);
param_4.z=-atan2(l9_21[1].x,l9_21[0].x);
param_4*=57.29578;
Position_N5=param_3;
Rotation_N5=param_4;
Scale_N5=param_5;
...
float3 param_7=Position_N5;
float3 param_8=Rotation_N5;
float3 param_9=Scale_N5;
...
N2_rot=param_8;
N2_scale=param_9;
float l9_23=gParticle.Ratio1DPerCopy;
float l9_24=l9_23;
float l9_25=N2_texSize*N2_texSize;
float l9_26=floor((l9_24*(l9_25-1.0))+0.5);
float l9_27=floor(l9_26/N2_texSize);
float l9_28=mod(l9_26,N2_texSize);
float l9_29=(l9_28+0.5)/N2_texSize;
float l9_30=(l9_27+0.5)/N2_texSize;
float2 l9_31=float2(l9_29,l9_30);
float4 l9_32=float4(0.0);
int l9_33;
if ((int(labLAHasSwappedViews_tmp)!=0))
{
int l9_34=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_38=l9_33;
int l9_39=labLALayout_tmp;
int l9_40=l9_38;
float2 l9_41=l9_31;
bool l9_42=(int(SC_USE_UV_TRANSFORM_labLA_tmp)!=0);
float3x3 l9_43=(*sc_set0.UserUniforms).labLATransform;
int2 l9_44=int2(SC_SOFTWARE_WRAP_MODE_U_labLA_tmp,SC_SOFTWARE_WRAP_MODE_V_labLA_tmp);
bool l9_45=(int(SC_USE_UV_MIN_MAX_labLA_tmp)!=0);
float4 l9_46=(*sc_set0.UserUniforms).labLAUvMinMax;
bool l9_47=(int(SC_USE_CLAMP_TO_BORDER_labLA_tmp)!=0);
float4 l9_48=(*sc_set0.UserUniforms).labLABorderColor;
float l9_49=0.0;
...
float4 l9_116=sc_set0.labLA.sample(sc_set0.labLASmpSC,l9_115.xy,level(l9_109));
...
float2 l9_121=float2(l9_29,l9_30);
float4 l9_122=float4(0.0);
int l9_123;
if ((int(labBVHasSwappedViews_tmp)!=0))
{
int l9_124=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_128=l9_123;
int l9_129=labBVLayout_tmp;
int l9_130=l9_128;
float2 l9_131=l9_121;
bool l9_132=(int(SC_USE_UV_TRANSFORM_labBV_tmp)!=0);
float3x3 l9_133=(*sc_set0.UserUniforms).labBVTransform;
int2 l9_134=int2(SC_SOFTWARE_WRAP_MODE_U_labBV_tmp,SC_SOFTWARE_WRAP_MODE_V_labBV_tmp);
bool l9_135=(int(SC_USE_UV_MIN_MAX_labBV_tmp)!=0);
float4 l9_136=(*sc_set0.UserUniforms).labBVUvMinMax;
bool l9_137=(int(SC_USE_CLAMP_TO_BORDER_labBV_tmp)!=0);
float4 l9_138=(*sc_set0.UserUniforms).labBVBorderColor;
float l9_139=0.0;
...
if (l9_201==0)
{
l9_203=float3(l9_200,0.0);
}
else
{
if (l9_201==1)
{
l9_203=float3(l9_200.x,(l9_200.y*0.5)+(0.5-(float(l9_202)*0.5)),0.0);
}
else
{
l9_203=float3(l9_200,float(l9_202));
}
}
float3 l9_204=l9_203;
float3 l9_205=l9_204;
float4 l9_206=sc_set0.labBV.sample(sc_set0.labBVSmpSC,l9_205.xy,level(l9_199));
float4 l9_207=l9_206;
if (l9_137)
{
l9_207=mix(l9_138,l9_207,float4(l9_141));
}
float4 l9_208=l9_207;
l9_122=l9_208;
float4 l9_209=l9_122;
float4 l9_210=l9_209;
float2 l9_211=float2(l9_29,l9_30);
...
int l9_218=l9_213;
int l9_219=colorMapLayout_tmp;
int l9_220=l9_218;
float2 l9_221=l9_211;
bool l9_222=(int(SC_USE_UV_TRANSFORM_colorMap_tmp)!=0);
float3x3 l9_223=(*sc_set0.UserUniforms).colorMapTransform;
int2 l9_224=int2(SC_SOFTWARE_WRAP_MODE_U_colorMap_tmp,SC_SOFTWARE_WRAP_MODE_V_colorMap_tmp);
bool l9_225=(int(SC_USE_UV_MIN_MAX_colorMap_tmp)!=0);
float4 l9_226=(*sc_set0.UserUniforms).colorMapUvMinMax;
bool l9_227=(int(SC_USE_CLAMP_TO_BORDER_colorMap_tmp)!=0);
float4 l9_228=(*sc_set0.UserUniforms).colorMapBorderColor;
float l9_229=0.0;
...
l9_221.y=l9_275;
l9_231=l9_278;
float2 l9_286=l9_221;
int l9_287=l9_219;
int l9_288=l9_220;
float l9_289=l9_229;
float2 l9_290=l9_286;
int l9_291=l9_287;
int l9_292=l9_288;
float3 l9_293=float3(0.0);
if (l9_291==0)
{
l9_293=float3(l9_290,0.0);
}
else
{
if (l9_291==1)
{
l9_293=float3(l9_290.x,(l9_290.y*0.5)+(0.5-(float(l9_292)*0.5)),0.0);
}
else
{
l9_293=float3(l9_290,float(l9_292));
}
}
float3 l9_294=l9_293;
float3 l9_295=l9_294;
float4 l9_296=sc_set0.colorMap.sample(sc_set0.colorMapSmpSC,l9_295.xy,level(l9_289));
float4 l9_297=l9_296;
if (l9_227)
{
l9_297=mix(l9_228,l9_297,float4(l9_231));
}
float4 l9_298=l9_297;
l9_212=l9_298;
float4 l9_299=l9_212;
float4 l9_300=l9_299;
float l9_301=l9_120.x;
float l9_302=l9_120.y;
float l9_303=(((l9_301*255.0)*256.0)+(l9_302*255.0))/65535.0;
float l9_304=l9_303;
float l9_305=l9_120.z;
float l9_306=l9_120.w;
float l9_307=(((l9_305*255.0)*256.0)+(l9_306*255.0))/65535.0;
float l9_308=l9_307;
float l9_309=l9_210.x;
float l9_310=l9_210.y;
float l9_311=(((l9_309*255.0)*256.0)+(l9_310*255.0))/65535.0;
float l9_312=l9_311;
float l9_313=l9_304*100.0;
float l9_314=(l9_308*300.0)-150.0;
float l9_315=(l9_312*300.0)-150.0;
float3 l9_316=float3(l9_314/300.0,(l9_313/100.0)-0.5,l9_315/300.0);
float3 l9_317=l9_316*N2_scale;
float3 l9_318=N2_rot*0.017453292;
float l9_319=cos(l9_318.x);
float l9_320=sin(l9_318.x);
float l9_321=cos(l9_318.y);
float l9_322=sin(l9_318.y);
float l9_323=cos(l9_318.z);
float l9_324=sin(l9_318.z);
float3 l9_325=float3((l9_317.x*l9_321)+(l9_317.z*l9_322),l9_317.y,((-l9_317.x)*l9_322)+(l9_317.z*l9_321));
float3 l9_326=float3(l9_325.x,(l9_325.y*l9_319)-(l9_325.z*l9_320),(l9_325.y*l9_320)+(l9_325.z*l9_319));
float3 l9_327=float3((l9_326.x*l9_323)-(l9_326.y*l9_324),(l9_326.x*l9_324)+(l9_326.y*l9_323),l9_326.z);
N2_particlePosition=l9_327+N2_pos;
N2_particleColor=float4(l9_300.xyz,1.0);
param_10=N2_particlePosition;
param_11=N2_particleColor;
particlePosition_N2=param_10;
particleColor_N2=param_11;
...
float4 l9_328=param_13;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_329=dot(l9_328,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_330=l9_329;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_330;
}
}
float4 l9_331=float4(param_13.x,-param_13.y,(param_13.z*0.5)+(param_13.w*0.5),param_13.w);
out.gl_Position=l9_331;
return out;
}
float l9_332;
...
{
l9_332=gParticle.Force.x;
}
gParticle.Force.x=l9_332;
float l9_333;
...
{
l9_333=gParticle.Force.y;
}
gParticle.Force.y=l9_333;
float l9_334;
...
{
l9_334=gParticle.Force.z;
}
gParticle.Force.z=l9_334;
...
{
l9_335=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_335;
float l9_336;
...
{
l9_336=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_336;
float l9_337;
...
{
l9_337=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_337;
...
float4 l9_343=float4(param_14.x,-param_14.y,(param_14.z*0.5)+(param_14.w*0.5),param_14.w);
...
float4 l9_344=param_15;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_345=dot(l9_344,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_346=l9_345;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_346;
}
}
float4 l9_347=float4(param_15.x,-param_15.y,(param_15.z*0.5)+(param_15.w*0.5),param_15.w);
out.gl_Position=l9_347;
return out;
}
return out;
}
