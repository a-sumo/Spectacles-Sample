...
float l9_5=(float(l9_4)+0.5)/N0_texWidth;
float2 l9_6=float2(l9_5,0.5);
...
int l9_12=l9_3;
int l9_13=pigmentTexLayout_tmp;
int l9_14=l9_12;
float2 l9_15=l9_6;
bool l9_16=(int(SC_USE_UV_TRANSFORM_pigmentTex_tmp)!=0);
float3x3 l9_17=(*sc_set0.UserUniforms).pigmentTexTransform;
int2 l9_18=int2(SC_SOFTWARE_WRAP_MODE_U_pigmentTex_tmp,SC_SOFTWARE_WRAP_MODE_V_pigmentTex_tmp);
bool l9_19=(int(SC_USE_UV_MIN_MAX_pigmentTex_tmp)!=0);
float4 l9_20=(*sc_set0.UserUniforms).pigmentTexUvMinMax;
bool l9_21=(int(SC_USE_CLAMP_TO_BORDER_pigmentTex_tmp)!=0);
float4 l9_22=(*sc_set0.UserUniforms).pigmentTexBorderColor;
float l9_23=0.0;
...
float3 l9_88=l9_87;
float3 l9_89=l9_88;
float4 l9_90=sc_set0.pigmentTex.sample(sc_set0.pigmentTexSmpSC,l9_89.xy,bias(l9_83));
float4 l9_91=l9_90;
if (l9_21)
{
...
float l9_98=(float(l9_97)+0.5)/N0_texWidth;
float2 l9_99=float2(l9_98,0.5);
...
int l9_105=l9_96;
int l9_106=pigmentTexLayout_tmp;
int l9_107=l9_105;
float2 l9_108=l9_99;
bool l9_109=(int(SC_USE_UV_TRANSFORM_pigmentTex_tmp)!=0);
float3x3 l9_110=(*sc_set0.UserUniforms).pigmentTexTransform;
int2 l9_111=int2(SC_SOFTWARE_WRAP_MODE_U_pigmentTex_tmp,SC_SOFTWARE_WRAP_MODE_V_pigmentTex_tmp);
bool l9_112=(int(SC_USE_UV_MIN_MAX_pigmentTex_tmp)!=0);
float4 l9_113=(*sc_set0.UserUniforms).pigmentTexUvMinMax;
bool l9_114=(int(SC_USE_CLAMP_TO_BORDER_pigmentTex_tmp)!=0);
float4 l9_115=(*sc_set0.UserUniforms).pigmentTexBorderColor;
float l9_116=0.0;
...
float4 l9_183=sc_set0.pigmentTex.sample(sc_set0.pigmentTexSmpSC,l9_182.xy,bias(l9_176));
float4 l9_184=l9_183;
if (l9_114)
{
l9_184=mix(l9_115,l9_184,float4(l9_118));
}
float4 l9_185=l9_184;
l9_100=l9_185;
float4 l9_186=l9_100;
float4 l9_187=l9_186;
l9_95+=(l9_187.xyz*(l9_187.w/l9_2));
l9_97++;
continue;
}
else
...
N0_mixedColor=float4(l9_95,1.0);
...
float4 l9_191=fast::max(param_7,float4(0.0));
float4 param_8=l9_191;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_200=param_9;
float4 l9_201=float4(0.0);
float4 l9_202=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_203=out.sc_FragData0;
l9_202=l9_203;
}
else
{
float4 l9_204=gl_FragCoord;
float2 l9_205=l9_204.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_210=l9_209;
int l9_211=l9_210;
float3 l9_212=float3(l9_206,0.0);
int l9_213=l9_208;
int l9_214=l9_211;
if (l9_213==1)
{
l9_212.y=((2.0*l9_212.y)+float(l9_214))-1.0;
}
float2 l9_215=l9_212.xy;
l9_207=l9_215;
}
else
{
...
int l9_228=sc_ScreenTextureLayout_tmp;
int l9_229=l9_226;
float l9_230=l9_220;
...
float4 l9_237=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_236.xy,bias(l9_230));
float4 l9_238=l9_237;
float4 l9_239=l9_238;
l9_202=l9_239;
}
float4 l9_240=l9_202;
float3 l9_241=l9_240.xyz;
float3 l9_242=l9_241;
float3 l9_243=l9_200.xyz;
float3 l9_244=definedBlend(l9_242,l9_243,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_201=float4(l9_244.x,l9_244.y,l9_244.z,l9_201.w);
float3 l9_245=mix(l9_241,l9_201.xyz,float3(l9_200.w));
l9_201=float4(l9_245.x,l9_245.y,l9_245.z,l9_201.w);
l9_201.w=1.0;
float4 l9_246=l9_201;
param_9=l9_246;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_247=float4(in.varScreenPos.xyz,1.0);
param_9=l9_247;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_248=gl_FragCoord;
float l9_249=fast::clamp(abs(l9_248.z),0.0,1.0);
float4 l9_250=float4(l9_249,1.0-l9_249,1.0,1.0);
param_9=l9_250;
}
else
{
float4 l9_251=param_9;
float4 l9_252=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_252=float4(mix(float3(1.0),l9_251.xyz,float3(l9_251.w)),l9_251.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_253=l9_251.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_253=fast::clamp(l9_253,0.0,1.0);
}
l9_252=float4(l9_251.xyz*l9_253,l9_253);
}
else
{
l9_252=l9_251;
...
float4 l9_258=param_11;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_258.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_258;
return out;
}
} // FRAGMENT SHADER
