...
exports.ImprovedToggleFeedback = void 0;
var __selfType = requireType("./ImprovedToggleFeedback");
...
const ToggleButton_1 = require("SpectaclesInteractionKit.lspkg/Components/UI/ToggleButton/ToggleButton");
/**
 ...
 */
let ImprovedToggleFeedback = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var ImprovedToggleFeedback = _classThis = class extends _classSuper {
        constructor() {
            super();
            /**
    ...
    __setFunctionName(_classThis, "ImprovedToggleFeedback");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ImprovedToggleFeedback = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ImprovedToggleFeedback = _classThis;
})();
exports.ImprovedToggleFeedback = ImprovedToggleFeedback;
//# sourceMappingURL=ImprovedToggleFeedback.js.map