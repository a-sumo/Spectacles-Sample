...
//float radius 4384
//float strokeWidth 4388
//float4 mainColor 4400
//float2 Port_size_N009 4416
//float4 Port_Value_N001 4432
//float2 Port_uvOffset_N009 4448
//float depthRef 4456
//}
...
float strokeWidth;
float4 mainColor;
float2 Port_size_N009;
float4 Port_Value_N001;
float2 Port_uvOffset_N009;
float depthRef;
};
struct sc_Bone_t
{
...
{
main_frag_out out={};
float2 N9_size=float2(0.0);
float N9_radius=0.0;
float N9_strokeWidth=0.0;
float4 N9_fillColor=float4(0.0);
float4 N9_strokeColor=float4(0.0);
float2 N9_surfaceUVCoords=float2(0.0);
float3 N9_surfaceWorldScale=float3(0.0);
float2 N9_uvOffset=float2(0.0);
float4 N9_Output=float4(0.0);
...
float Output_N2=0.0;
float param_1=(*sc_set0.UserUniforms).radius;
Output_N2=param_1;
float Output_N5=0.0;
float param_2=(*sc_set0.UserUniforms).strokeWidth;
Output_N5=param_2;
float4 Output_N3=float4(0.0);
float4 param_3=(*sc_set0.UserUniforms).mainColor;
Output_N3=param_3;
float4 Output_N1=float4(0.0);
Output_N1=(*sc_set0.UserUniforms).Port_Value_N001;
float2 UVCoord_N0=float2(0.0);
UVCoord_N0=Globals.Surface_UVCoord0;
float3 Scale_N10=float3(0.0);
float4x4 l9_1=(*sc_set0.UserUniforms).sc_ModelMatrix;
float3 param_4=float3(length(l9_1[0].xyz),length(l9_1[1].xyz),length(l9_1[2].xyz));
Scale_N10=param_4;
float4 Output_N9=float4(0.0);
float2 param_5=(*sc_set0.UserUniforms).Port_size_N009;
float param_6=Output_N2;
float param_7=Output_N5;
float4 param_8=Output_N3;
float4 param_9=Output_N1;
float2 param_10=UVCoord_N0;
float3 param_11=Scale_N10;
float2 param_12=(*sc_set0.UserUniforms).Port_uvOffset_N009;
float4 param_13=float4(0.0);
N9_size=param_5;
N9_radius=param_6;
N9_strokeWidth=param_7;
N9_fillColor=param_8;
N9_strokeColor=param_9;
N9_surfaceUVCoords=param_10;
N9_surfaceWorldScale=param_11;
N9_uvOffset=param_12;
float l9_2=N9_surfaceWorldScale.x/N9_surfaceWorldScale.y;
float2 l9_3=N9_surfaceUVCoords-N9_uvOffset;
float2 l9_4=float2(l9_3.x,l9_3.y/l9_2);
float2 l9_5=N9_size*0.5;
float2 l9_6=l9_4;
float2 l9_7=l9_5;
float l9_8=N9_radius;
...
float2 l9_13=l9_5-float2(N9_strokeWidth);
float l9_14=fast::max(N9_radius-N9_strokeWidth,0.0);
float2 l9_15=l9_4;
float2 l9_16=l9_13;
float l9_17=l9_14;
...
float l9_23=l9_21;
float4 l9_24=N9_fillColor*l9_23;
float4 l9_25=N9_strokeColor*l9_22;
N9_Output=l9_24+l9_25;
param_13=N9_Output;
Output_N9=param_13;
FinalColor=Output_N9;
...
float4 l9_29=fast::max(param_15,float4(0.0));
float4 param_16=l9_29;
if (sc_ShaderCacheConstant_tmp!=0)
{
