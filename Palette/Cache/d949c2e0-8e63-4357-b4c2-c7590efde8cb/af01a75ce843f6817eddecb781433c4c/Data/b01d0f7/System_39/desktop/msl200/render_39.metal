...
float2 Port_SizeMult_N011;
float2 Port_PivotPoint_N011;
float Port_VelocityStretchAmount_N011;
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/60000]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(60000*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/60000]!=0)==false;
}
else
{
l9_5=l9_4;
...
float3 l9_23=gParticle.Position+((gParticle.Matrix*v.position.xyz)*gParticle.Size);
out.varPosAndMotion=float4(l9_23.x,l9_23.y,l9_23.z,out.varPosAndMotion.w);
float3 l9_24=gParticle.Matrix*v.normal;
out.varNormalAndMotion=float4(l9_24.x,l9_24.y,l9_24.z,out.varNormalAndMotion.w);
float3 l9_25=gParticle.Matrix*v.tangent;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/60000];
...
{
l9_24=pow(Output_N261,Value_N286);
}
Output_N287=l9_24;
...
{
float4 l9_25=param_6;
float4 l9_26=float4(0.0);
float4 l9_27=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_28=out.sc_FragData0;
l9_27=l9_28;
}
else
{
float4 l9_29=gl_FragCoord;
float2 l9_30=l9_29.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_31=l9_30;
...
int l9_35=l9_34;
int l9_36=l9_35;
float3 l9_37=float3(l9_31,0.0);
int l9_38=l9_33;
int l9_39=l9_36;
if (l9_38==1)
{
l9_37.y=((2.0*l9_37.y)+float(l9_39))-1.0;
}
float2 l9_40=l9_37.xy;
l9_32=l9_40;
}
else
{
...
int l9_51=l9_46;
float2 l9_52=l9_44;
int l9_53=sc_ScreenTextureLayout_tmp;
int l9_54=l9_51;
float l9_55=l9_45;
float2 l9_56=l9_52;
int l9_57=l9_53;
...
if (l9_57==0)
{
l9_59=float3(l9_56,0.0);
}
else
{
if (l9_57==1)
{
l9_59=float3(l9_56.x,(l9_56.y*0.5)+(0.5-(float(l9_58)*0.5)),0.0);
}
else
{
l9_59=float3(l9_56,float(l9_58));
}
}
float3 l9_60=l9_59;
float3 l9_61=l9_60;
float4 l9_62=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_61.xy,bias(l9_55));
float4 l9_63=l9_62;
float4 l9_64=l9_63;
l9_27=l9_64;
}
...
l9_26=float4(l9_69.x,l9_69.y,l9_69.z,l9_26.w);
float3 l9_70=mix(l9_66,l9_26.xyz,float3(l9_25.w));
l9_26=float4(l9_70.x,l9_70.y,l9_70.z,l9_26.w);
l9_26.w=1.0;
float4 l9_71=l9_26;
param_6=l9_71;
}
...
{
float4 l9_72=float4(in.varScreenPos.xyz,1.0);
param_6=l9_72;
}
else
{
...
float l9_74=fast::clamp(abs(l9_73.z),0.0,1.0);
float4 l9_75=float4(l9_74,1.0-l9_74,1.0,1.0);
param_6=l9_75;
}
else
{
