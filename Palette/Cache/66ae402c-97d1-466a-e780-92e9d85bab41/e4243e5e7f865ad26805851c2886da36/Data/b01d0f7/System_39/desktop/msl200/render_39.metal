...
param.CopyId=float(param_1/8192);
...
if (!l9_41)
{
l9_42=!(UserUniforms.vfxBatchEnable[ssInstanceID/8192]!=0);
}
else
{
l9_42=l9_41;
...
bool l9_4=l9_3>=(8192*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/8192]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/8192];
...
float3 l9_20=gParticle.Position+((gParticle.Matrix*v.position.xyz)*gParticle.Size);
out.varPosAndMotion=float4(l9_20.x,l9_20.y,l9_20.z,out.varPosAndMotion.w);
float3 l9_21=gParticle.Matrix*v.normal;
out.varNormalAndMotion=float4(l9_21.x,l9_21.y,l9_21.z,out.varNormalAndMotion.w);
float3 l9_22=gParticle.Matrix*v.tangent;
...
int l9_24=l9_23;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_24]*float4(out.varPosAndMotion.xyz,1.0);
...
int l9_26=l9_25;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_26][2].w!=0.0)
{
float l9_27=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
param_4.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_4.w))*l9_27)-1.0)*param_4.w;
}
}
float4 l9_28=param_4;
clipPosition=l9_28;
...
float4 l9_29=param_5;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_30=dot(l9_29,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_31=l9_30;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_31;
}
}
float4 l9_32=float4(param_5.x,-param_5.y,(param_5.z*0.5)+(param_5.w*0.5),param_5.w);
out.gl_Position=l9_32;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/8192];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
param_1.Index1DPerCopy=param%8192;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(8192*((param/8192)+1))-1;
