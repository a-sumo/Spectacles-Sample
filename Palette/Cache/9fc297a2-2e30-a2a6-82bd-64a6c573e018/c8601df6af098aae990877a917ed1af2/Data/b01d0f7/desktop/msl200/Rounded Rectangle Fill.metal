...
//float Port_offset_N005 4384
//float Port_radius_N005 4388
//float4 Port_fillColor_N005 4400
//float3 Port_surfaceWorldScale_N005 4416
//float2 Port_uvOffset_N005 4432
//float depthRef 4440
//}
...
float Port_offset_N005;
float Port_radius_N005;
float4 Port_fillColor_N005;
float3 Port_surfaceWorldScale_N005;
...
float param_1=(*sc_set0.UserUniforms).Port_offset_N005;
float param_2=(*sc_set0.UserUniforms).Port_radius_N005;
float4 param_3=(*sc_set0.UserUniforms).Port_fillColor_N005;
float2 param_4=UVCoord_N0;
float3 param_5=(*sc_set0.UserUniforms).Port_surfaceWorldScale_N005;
float2 param_6=(*sc_set0.UserUniforms).Port_uvOffset_N005;
float4 param_7=float4(0.0);
N5_offset=param_1;
N5_radius=param_2;
N5_fillColor=param_3;
N5_surfaceUVCoords=param_4;
N5_surfaceWorldScale=param_5;
N5_uvOffset=param_6;
float l9_1;
if (N5_surfaceWorldScale.y>9.9999997e-05)
{
l9_1=N5_surfaceWorldScale.x/N5_surfaceWorldScale.y;
}
else
{
l9_1=1.0;
...
float l9_2=l9_1;
float l9_3=0.0020000001;
float2 l9_4=N5_surfaceUVCoords-N5_uvOffset;
float l9_5=0.5-N5_offset;
float l9_6=0.5-(N5_offset*l9_2);
float2 l9_7=float2(N5_radius,N5_radius*l9_2);
float2 l9_8=float2(l9_5-N5_radius,l9_6-(N5_radius*l9_2));
float l9_9=0.0;
float2 l9_10=l9_4-float2(l9_8.x,l9_8.y);
float2 l9_11=l9_7;
float l9_12=length(l9_10/l9_11);
float l9_13=length(l9_10/(l9_11*l9_11));
float l9_14=(l9_12*(l9_12-1.0))/l9_13;
float l9_15=l9_14;
l9_9=fast::max(l9_9,smoothstep(l9_3,-l9_3,l9_15));
float2 l9_16=l9_4-float2(-l9_8.x,l9_8.y);
float2 l9_17=l9_7;
float l9_18=length(l9_16/l9_17);
float l9_19=length(l9_16/(l9_17*l9_17));
float l9_20=(l9_18*(l9_18-1.0))/l9_19;
float l9_21=l9_20;
l9_9=fast::max(l9_9,smoothstep(l9_3,-l9_3,l9_21));
float2 l9_22=l9_4-float2(l9_8.x,-l9_8.y);
float2 l9_23=l9_7;
float l9_24=length(l9_22/l9_23);
float l9_25=length(l9_22/(l9_23*l9_23));
float l9_26=(l9_24*(l9_24-1.0))/l9_25;
float l9_27=l9_26;
l9_9=fast::max(l9_9,smoothstep(l9_3,-l9_3,l9_27));
float2 l9_28=l9_4-float2(-l9_8.x,-l9_8.y);
float2 l9_29=l9_7;
float l9_30=length(l9_28/l9_29);
float l9_31=length(l9_28/(l9_29*l9_29));
float l9_32=(l9_30*(l9_30-1.0))/l9_31;
float l9_33=l9_32;
l9_9=fast::max(l9_9,smoothstep(l9_3,-l9_3,l9_33));
float2 l9_34=l9_4;
float2 l9_35=float2(l9_5-N5_radius,l9_6);
float2 l9_36=abs(l9_34)-l9_35;
float l9_37=length(fast::max(l9_36,float2(0.0)))+fast::min(fast::max(l9_36.x,l9_36.y),0.0);
float l9_38=l9_37;
l9_9=fast::max(l9_9,smoothstep(l9_3,-l9_3,l9_38));
float2 l9_39=l9_4;
float2 l9_40=float2(l9_5,l9_6-(N5_radius*l9_2));
float2 l9_41=abs(l9_39)-l9_40;
float l9_42=length(fast::max(l9_41,float2(0.0)))+fast::min(fast::max(l9_41.x,l9_41.y),0.0);
float l9_43=l9_42;
l9_9=fast::max(l9_9,smoothstep(l9_3,-l9_3,l9_43));
N5_Output=N5_fillColor*l9_9;
param_7=N5_Output;
Output_N5=param_7;
...
float4 l9_47=fast::max(param_9,float4(0.0));
float4 param_10=l9_47;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_50=fast::clamp(l9_49.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_50=fast::clamp(dot(l9_49.xyz,float3(l9_49.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_50=(1.0-dot(l9_49.xyz,float3(0.33333001)))*l9_49.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_50=(1.0-fast::clamp(dot(l9_49.xyz,float3(1.0)),0.0,1.0))*l9_49.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_50=fast::clamp(dot(l9_49.xyz,float3(1.0)),0.0,1.0)*l9_49.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_50=fast::clamp(dot(l9_49.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_50=dot(l9_49.xyz,float3(0.33333001))*l9_49.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_50=1.0-fast::clamp(dot(l9_49.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_51=l9_50;
float l9_52=l9_51;
float l9_53=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_52;
float3 l9_54=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_48.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_55=float4(l9_54.x,l9_54.y,l9_54.z,l9_53);
param_11=l9_55;
}
else
{
...
{
float4 l9_56=param_11;
float4 l9_57=float4(0.0);
float4 l9_58=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_59=out.sc_FragData0;
l9_58=l9_59;
}
else
{
float4 l9_60=gl_FragCoord;
float2 l9_61=l9_60.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_62=l9_61;
...
int l9_66=l9_65;
int l9_67=l9_66;
float3 l9_68=float3(l9_62,0.0);
int l9_69=l9_64;
int l9_70=l9_67;
if (l9_69==1)
{
l9_68.y=((2.0*l9_68.y)+float(l9_70))-1.0;
}
float2 l9_71=l9_68.xy;
l9_63=l9_71;
}
else
{
...
int l9_82=l9_77;
float2 l9_83=l9_75;
int l9_84=sc_ScreenTextureLayout_tmp;
int l9_85=l9_82;
float l9_86=l9_76;
float2 l9_87=l9_83;
int l9_88=l9_84;
...
float3 l9_91=l9_90;
float3 l9_92=l9_91;
float4 l9_93=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_92.xy,bias(l9_86));
float4 l9_94=l9_93;
float4 l9_95=l9_94;
l9_58=l9_95;
}
float4 l9_96=l9_58;
float3 l9_97=l9_96.xyz;
float3 l9_98=l9_97;
float3 l9_99=l9_56.xyz;
float3 l9_100=definedBlend(l9_98,l9_99,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_57=float4(l9_100.x,l9_100.y,l9_100.z,l9_57.w);
float3 l9_101=mix(l9_97,l9_57.xyz,float3(l9_56.w));
l9_57=float4(l9_101.x,l9_101.y,l9_101.z,l9_57.w);
l9_57.w=1.0;
float4 l9_102=l9_57;
param_11=l9_102;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_103=float4(in.varScreenPos.xyz,1.0);
param_11=l9_103;
}
else
{
...
float l9_105=fast::clamp(abs(l9_104.z),0.0,1.0);
float4 l9_106=float4(l9_105,1.0-l9_105,1.0,1.0);
param_11=l9_106;
}
else
{
float4 l9_107=param_11;
float4 l9_108=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_108=float4(mix(float3(1.0),l9_107.xyz,float3(l9_107.w)),l9_107.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_109=l9_107.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_109=fast::clamp(l9_109,0.0,1.0);
}
l9_108=float4(l9_107.xyz*l9_109,l9_109);
}
else
{
l9_108=l9_107;
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_114.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_114;
return out;
}
} // FRAGMENT SHADER
