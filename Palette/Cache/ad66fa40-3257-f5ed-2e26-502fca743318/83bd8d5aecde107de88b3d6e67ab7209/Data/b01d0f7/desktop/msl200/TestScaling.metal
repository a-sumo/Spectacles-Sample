...
//}
//ubo int UserUniforms 0:31:4560 {
//float4 sc_Time 1376
...
//float Port_Switch_N002 4384
//float2 Port_size_N005 4392
//float Port_radius_N005 4400
//float Port_strokeWidth_N005 4404
//float4 Port_fillColor_N005 4416
//float4 Port_strokeColor_N005 4432
//float2 Port_uvOffset_N005 4448
//float2 Port_size_N018 4456
//float Port_radius_N018 4464
//float Port_strokeWidth_N018 4468
//float Port_cornerLength_N018 4472
//float4 Port_strokeColor_N018 4480
//float2 Port_uvOffset_N018 4496
//float Port_gridCountX_N029 4504
//float Port_gridCountY_N029 4508
//float Port_strokeWidth_N029 4512
//float Port_softness_N029 4516
//float Port_feather_N029 4520
//float4 Port_gridColor_N029 4528
//float2 Port_uvOffset_N029 4544
//float depthRef 4552
//}
...
float Port_Switch_N002;
float2 Port_size_N005;
float Port_radius_N005;
float Port_strokeWidth_N005;
float4 Port_fillColor_N005;
float4 Port_strokeColor_N005;
float2 Port_uvOffset_N005;
float2 Port_size_N018;
float Port_radius_N018;
float Port_strokeWidth_N018;
float Port_cornerLength_N018;
float4 Port_strokeColor_N018;
float2 Port_uvOffset_N018;
float Port_gridCountX_N029;
float Port_gridCountY_N029;
float Port_strokeWidth_N029;
float Port_softness_N029;
float Port_feather_N029;
float4 Port_gridColor_N029;
float2 Port_uvOffset_N029;
float depthRef;
};
struct sc_Bone_t
{
...
{
main_frag_out out={};
float2 N5_size=float2(0.0);
float N5_radius=0.0;
float N5_strokeWidth=0.0;
float4 N5_fillColor=float4(0.0);
float4 N5_strokeColor=float4(0.0);
float2 N5_surfaceUVCoords=float2(0.0);
float3 N5_surfaceWorldScale=float3(0.0);
float2 N5_uvOffset=float2(0.0);
float4 N5_Output=float4(0.0);
float2 N18_size=float2(0.0);
float N18_radius=0.0;
float N18_strokeWidth=0.0;
float N18_cornerLength=0.0;
float4 N18_strokeColor=float4(0.0);
float2 N18_surfaceUVCoords=float2(0.0);
float3 N18_surfaceWorldScale=float3(0.0);
float2 N18_uvOffset=float2(0.0);
float4 N18_Output=float4(0.0);
float N29_gridCountX=0.0;
float N29_gridCountY=0.0;
float N29_strokeWidth=0.0;
float N29_softness=0.0;
float N29_feather=0.0;
float4 N29_gridColor=float4(0.0);
float2 N29_surfaceUVCoords=float2(0.0);
float3 N29_surfaceWorldScale=float3(0.0);
float2 N29_uvOffset=float2(0.0);
float4 N29_Output=float4(0.0);
...
float param_1=(*sc_set0.UserUniforms).Port_Switch_N002;
...
l9_1=param_7.Surface_UVCoord0;
float3 l9_2=float3(0.0);
float4x4 l9_3=(*sc_set0.UserUniforms).sc_ModelMatrix;
float3 l9_4=float3(length(l9_3[0].xyz),length(l9_3[1].xyz),length(l9_3[2].xyz));
l9_2=l9_4;
float4 l9_5=float4(0.0);
float2 l9_6=(*sc_set0.UserUniforms).Port_size_N005;
float l9_7=(*sc_set0.UserUniforms).Port_radius_N005;
float l9_8=(*sc_set0.UserUniforms).Port_strokeWidth_N005;
float4 l9_9=(*sc_set0.UserUniforms).Port_fillColor_N005;
float4 l9_10=(*sc_set0.UserUniforms).Port_strokeColor_N005;
float2 l9_11=l9_1;
float3 l9_12=l9_2;
float2 l9_13=(*sc_set0.UserUniforms).Port_uvOffset_N005;
float4 l9_14=float4(0.0);
N5_size=l9_6;
N5_radius=l9_7;
N5_strokeWidth=l9_8;
N5_fillColor=l9_9;
N5_strokeColor=l9_10;
N5_surfaceUVCoords=l9_11;
N5_surfaceWorldScale=l9_12;
N5_uvOffset=l9_13;
float l9_15=N5_surfaceWorldScale.x/N5_surfaceWorldScale.y;
float2 l9_16=N5_surfaceUVCoords-N5_uvOffset;
float2 l9_17=float2(l9_16.x,l9_16.y/l9_15);
float2 l9_18=N5_size*0.5;
float2 l9_19=l9_17;
float2 l9_20=l9_18;
float l9_21=N5_radius;
float2 l9_22=(abs(l9_19)-l9_20)+float2(l9_21);
float l9_23=(length(fast::max(l9_22,float2(0.0)))+fast::min(fast::max(l9_22.x,l9_22.y),0.0))-l9_21;
float l9_24=l9_23;
float l9_25=step(l9_24,0.0);
float2 l9_26=l9_18-float2(N5_strokeWidth);
float l9_27=fast::max(N5_radius-N5_strokeWidth,0.0);
float2 l9_28=l9_17;
float2 l9_29=l9_26;
float l9_30=l9_27;
float2 l9_31=(abs(l9_28)-l9_29)+float2(l9_30);
float l9_32=(length(fast::max(l9_31,float2(0.0)))+fast::min(fast::max(l9_31.x,l9_31.y),0.0))-l9_30;
float l9_33=l9_32;
float l9_34=step(l9_33,0.0);
float l9_35=l9_25-l9_34;
float l9_36=l9_34;
float4 l9_37=N5_fillColor*l9_36;
float4 l9_38=N5_strokeColor*l9_35;
N5_Output=l9_37+l9_38;
l9_14=N5_Output;
l9_5=l9_14;
param_2=l9_5;
param_6=param_2;
...
l9_39=param_7.Surface_UVCoord0;
float3 l9_40=float3(0.0);
float4x4 l9_41=(*sc_set0.UserUniforms).sc_ModelMatrix;
float3 l9_42=float3(length(l9_41[0].xyz),length(l9_41[1].xyz),length(l9_41[2].xyz));
l9_40=l9_42;
float4 l9_43=float4(0.0);
float2 l9_44=(*sc_set0.UserUniforms).Port_size_N018;
float l9_45=(*sc_set0.UserUniforms).Port_radius_N018;
float l9_46=(*sc_set0.UserUniforms).Port_strokeWidth_N018;
float l9_47=(*sc_set0.UserUniforms).Port_cornerLength_N018;
float4 l9_48=(*sc_set0.UserUniforms).Port_strokeColor_N018;
float2 l9_49=l9_39;
float3 l9_50=l9_40;
float2 l9_51=(*sc_set0.UserUniforms).Port_uvOffset_N018;
float4 l9_52=float4(0.0);
N18_size=l9_44;
N18_radius=l9_45;
N18_strokeWidth=l9_46;
N18_cornerLength=l9_47;
N18_strokeColor=l9_48;
N18_surfaceUVCoords=l9_49;
N18_surfaceWorldScale=l9_50;
N18_uvOffset=l9_51;
float l9_53=N18_surfaceWorldScale.x/N18_surfaceWorldScale.y;
float l9_54=0.0049999999;
float2 l9_55=N18_surfaceUVCoords-N18_uvOffset;
float2 l9_56=float2(l9_55.x,l9_55.y/l9_53);
float2 l9_57=N18_size*0.5;
float2 l9_58=l9_57-float2(N18_cornerLength);
float2 l9_59=float2(N18_cornerLength);
float2 l9_60=float2(N18_strokeWidth);
float l9_61=0.0;
float2 l9_62=l9_56-l9_58;
float2 l9_63=l9_62;
float2 l9_64=l9_59;
float l9_65=N18_radius;
float2 l9_66=(abs(l9_63)-l9_64)+float2(l9_65);
float l9_67=(length(fast::max(l9_66,float2(0.0)))+fast::min(fast::max(l9_66.x,l9_66.y),0.0))-l9_65;
float l9_68=l9_67;
float2 l9_69=l9_62+l9_60;
float2 l9_70=l9_59-l9_60;
float l9_71=fast::max(N18_radius-N18_strokeWidth,0.0);
float2 l9_72=(abs(l9_69)-l9_70)+float2(l9_71);
float l9_73=(length(fast::max(l9_72,float2(0.0)))+fast::min(fast::max(l9_72.x,l9_72.y),0.0))-l9_71;
float l9_74=l9_73;
float l9_75=smoothstep(l9_54,-l9_54,l9_68)-smoothstep(l9_54,-l9_54,l9_74);
l9_61+=l9_75;
float2 l9_76=l9_56-float2(-l9_58.x,l9_58.y);
float2 l9_77=l9_76;
float2 l9_78=l9_59;
float l9_79=N18_radius;
float2 l9_80=(abs(l9_77)-l9_78)+float2(l9_79);
float l9_81=(length(fast::max(l9_80,float2(0.0)))+fast::min(fast::max(l9_80.x,l9_80.y),0.0))-l9_79;
float l9_82=l9_81;
float2 l9_83=l9_76+float2(-N18_strokeWidth,N18_strokeWidth);
float2 l9_84=l9_59-l9_60;
float l9_85=fast::max(N18_radius-N18_strokeWidth,0.0);
float2 l9_86=(abs(l9_83)-l9_84)+float2(l9_85);
float l9_87=(length(fast::max(l9_86,float2(0.0)))+fast::min(fast::max(l9_86.x,l9_86.y),0.0))-l9_85;
float l9_88=l9_87;
float l9_89=smoothstep(l9_54,-l9_54,l9_82)-smoothstep(l9_54,-l9_54,l9_88);
l9_61+=l9_89;
float2 l9_90=l9_56-float2(l9_58.x,-l9_58.y);
float2 l9_91=l9_90;
float2 l9_92=l9_59;
float l9_93=N18_radius;
float2 l9_94=(abs(l9_91)-l9_92)+float2(l9_93);
float l9_95=(length(fast::max(l9_94,float2(0.0)))+fast::min(fast::max(l9_94.x,l9_94.y),0.0))-l9_93;
float l9_96=l9_95;
float2 l9_97=l9_90+float2(N18_strokeWidth,-N18_strokeWidth);
float2 l9_98=l9_59-l9_60;
float l9_99=fast::max(N18_radius-N18_strokeWidth,0.0);
float2 l9_100=(abs(l9_97)-l9_98)+float2(l9_99);
float l9_101=(length(fast::max(l9_100,float2(0.0)))+fast::min(fast::max(l9_100.x,l9_100.y),0.0))-l9_99;
float l9_102=l9_101;
float l9_103=smoothstep(l9_54,-l9_54,l9_96)-smoothstep(l9_54,-l9_54,l9_102);
l9_61+=l9_103;
float2 l9_104=l9_56-float2(-l9_58.x,-l9_58.y);
float2 l9_105=l9_104;
float2 l9_106=l9_59;
float l9_107=N18_radius;
float2 l9_108=(abs(l9_105)-l9_106)+float2(l9_107);
float l9_109=(length(fast::max(l9_108,float2(0.0)))+fast::min(fast::max(l9_108.x,l9_108.y),0.0))-l9_107;
float l9_110=l9_109;
float2 l9_111=l9_104+float2(-N18_strokeWidth,-N18_strokeWidth);
float2 l9_112=l9_59-l9_60;
float l9_113=fast::max(N18_radius-N18_strokeWidth,0.0);
float2 l9_114=(abs(l9_111)-l9_112)+float2(l9_113);
float l9_115=(length(fast::max(l9_114,float2(0.0)))+fast::min(fast::max(l9_114.x,l9_114.y),0.0))-l9_113;
float l9_116=l9_115;
float l9_117=smoothstep(l9_54,-l9_54,l9_110)-smoothstep(l9_54,-l9_54,l9_116);
l9_61+=l9_117;
float l9_118=(l9_57.x-N18_cornerLength)+N18_radius;
float l9_119=(l9_57.y-N18_cornerLength)+N18_radius;
float2 l9_120=l9_56;
float l9_121=l9_118;
float l9_122=abs(l9_120.x)-l9_121;
float l9_123=l9_122;
float l9_124=smoothstep(l9_54,-l9_54,l9_123);
float2 l9_125=l9_56;
float l9_126=l9_119;
float l9_127=abs(l9_125.y)-l9_126;
float l9_128=l9_127;
float l9_129=smoothstep(l9_54,-l9_54,l9_128);
l9_61*=(1.0-fast::max(l9_124,l9_129));
N18_Output=N18_strokeColor*fast::clamp(l9_61,0.0,1.0);
l9_52=N18_Output;
l9_43=l9_52;
param_3=l9_43;
param_6=param_3;
...
l9_130=param_7.Surface_UVCoord0;
float3 l9_131=float3(0.0);
float4x4 l9_132=(*sc_set0.UserUniforms).sc_ModelMatrix;
float3 l9_133=float3(length(l9_132[0].xyz),length(l9_132[1].xyz),length(l9_132[2].xyz));
l9_131=l9_133;
float4 l9_134=float4(0.0);
float l9_135=(*sc_set0.UserUniforms).Port_gridCountX_N029;
float l9_136=(*sc_set0.UserUniforms).Port_gridCountY_N029;
float l9_137=(*sc_set0.UserUniforms).Port_strokeWidth_N029;
float l9_138=(*sc_set0.UserUniforms).Port_softness_N029;
float l9_139=(*sc_set0.UserUniforms).Port_feather_N029;
float4 l9_140=(*sc_set0.UserUniforms).Port_gridColor_N029;
float2 l9_141=l9_130;
float3 l9_142=l9_131;
float2 l9_143=(*sc_set0.UserUniforms).Port_uvOffset_N029;
float4 l9_144=float4(0.0);
N29_gridCountX=l9_135;
N29_gridCountY=l9_136;
N29_strokeWidth=l9_137;
N29_softness=l9_138;
N29_feather=l9_139;
N29_gridColor=l9_140;
N29_surfaceUVCoords=l9_141;
N29_surfaceWorldScale=l9_142;
N29_uvOffset=l9_143;
float l9_145=N29_surfaceWorldScale.x/N29_surfaceWorldScale.y;
float2 l9_146=N29_surfaceUVCoords-N29_uvOffset;
float2 l9_147=float2(l9_146.x,l9_146.y/l9_145);
float2 l9_148=l9_147+float2(0.5);
float l9_149=N29_strokeWidth*0.5;
float l9_150=0.0;
float l9_151=1.0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_151<=(N29_gridCountX-1.0))
{
float l9_152=l9_151/N29_gridCountX;
float l9_153=abs(l9_148.x-l9_152);
float l9_154=1.0-smoothstep(l9_149-N29_softness,(l9_149+N29_softness)+N29_feather,l9_153);
l9_150=fast::max(l9_150,l9_154);
l9_151+=1.0;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_155<=(N29_gridCountY-1.0))
{
float l9_156=l9_155/N29_gridCountY;
float l9_157=abs(l9_148.y-l9_156);
float l9_158=1.0-smoothstep(l9_149-N29_softness,(l9_149+N29_softness)+N29_feather,l9_157);
l9_150=fast::max(l9_150,l9_158);
l9_155+=1.0;
continue;
}
else
...
N29_Output=N29_gridColor*l9_150;
l9_144=N29_Output;
l9_134=l9_144;
param_4=l9_134;
param_6=param_4;
...
l9_159=param_7.Surface_UVCoord0;
float3 l9_160=float3(0.0);
float4x4 l9_161=(*sc_set0.UserUniforms).sc_ModelMatrix;
float3 l9_162=float3(length(l9_161[0].xyz),length(l9_161[1].xyz),length(l9_161[2].xyz));
l9_160=l9_162;
float4 l9_163=float4(0.0);
float2 l9_164=(*sc_set0.UserUniforms).Port_size_N005;
float l9_165=(*sc_set0.UserUniforms).Port_radius_N005;
float l9_166=(*sc_set0.UserUniforms).Port_strokeWidth_N005;
float4 l9_167=(*sc_set0.UserUniforms).Port_fillColor_N005;
float4 l9_168=(*sc_set0.UserUniforms).Port_strokeColor_N005;
float2 l9_169=l9_159;
float3 l9_170=l9_160;
float2 l9_171=(*sc_set0.UserUniforms).Port_uvOffset_N005;
float4 l9_172=float4(0.0);
N5_size=l9_164;
N5_radius=l9_165;
N5_strokeWidth=l9_166;
N5_fillColor=l9_167;
N5_strokeColor=l9_168;
N5_surfaceUVCoords=l9_169;
N5_surfaceWorldScale=l9_170;
N5_uvOffset=l9_171;
float l9_173=N5_surfaceWorldScale.x/N5_surfaceWorldScale.y;
float2 l9_174=N5_surfaceUVCoords-N5_uvOffset;
float2 l9_175=float2(l9_174.x,l9_174.y/l9_173);
float2 l9_176=N5_size*0.5;
float2 l9_177=l9_175;
float2 l9_178=l9_176;
float l9_179=N5_radius;
float2 l9_180=(abs(l9_177)-l9_178)+float2(l9_179);
float l9_181=(length(fast::max(l9_180,float2(0.0)))+fast::min(fast::max(l9_180.x,l9_180.y),0.0))-l9_179;
float l9_182=l9_181;
float l9_183=step(l9_182,0.0);
float2 l9_184=l9_176-float2(N5_strokeWidth);
float l9_185=fast::max(N5_radius-N5_strokeWidth,0.0);
float2 l9_186=l9_175;
float2 l9_187=l9_184;
float l9_188=l9_185;
float2 l9_189=(abs(l9_186)-l9_187)+float2(l9_188);
float l9_190=(length(fast::max(l9_189,float2(0.0)))+fast::min(fast::max(l9_189.x,l9_189.y),0.0))-l9_188;
float l9_191=l9_190;
float l9_192=step(l9_191,0.0);
float l9_193=l9_183-l9_192;
float l9_194=l9_192;
float4 l9_195=N5_fillColor*l9_194;
float4 l9_196=N5_strokeColor*l9_193;
N5_Output=l9_195+l9_196;
l9_172=N5_Output;
l9_163=l9_172;
param_5=l9_163;
param_6=param_5;
...
float2 l9_198=floor(mod(l9_197.xy,float2(4.0)));
float l9_199=(mod(dot(l9_198,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_8<l9_199)
{
discard_fragment();
}
...
float4 l9_200=fast::max(param_9,float4(0.0));
float4 param_10=l9_200;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_203=fast::clamp(l9_202.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_203=fast::clamp(dot(l9_202.xyz,float3(l9_202.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_203=(1.0-dot(l9_202.xyz,float3(0.33333001)))*l9_202.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_203=(1.0-fast::clamp(dot(l9_202.xyz,float3(1.0)),0.0,1.0))*l9_202.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_203=fast::clamp(dot(l9_202.xyz,float3(1.0)),0.0,1.0)*l9_202.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_203=fast::clamp(dot(l9_202.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_203=dot(l9_202.xyz,float3(0.33333001))*l9_202.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_203=1.0-fast::clamp(dot(l9_202.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_204=l9_203;
float l9_205=l9_204;
float l9_206=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_205;
float3 l9_207=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_201.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_208=float4(l9_207.x,l9_207.y,l9_207.z,l9_206);
param_11=l9_208;
}
else
{
...
{
float4 l9_209=param_11;
float4 l9_210=float4(0.0);
float4 l9_211=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_212=out.sc_FragData0;
l9_211=l9_212;
}
else
{
float4 l9_213=gl_FragCoord;
float2 l9_214=l9_213.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_219=l9_218;
int l9_220=l9_219;
float3 l9_221=float3(l9_215,0.0);
int l9_222=l9_217;
int l9_223=l9_220;
if (l9_222==1)
{
l9_221.y=((2.0*l9_221.y)+float(l9_223))-1.0;
}
float2 l9_224=l9_221.xy;
l9_216=l9_224;
}
else
{
...
float4 l9_246=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_245.xy,bias(l9_239));
float4 l9_247=l9_246;
float4 l9_248=l9_247;
l9_211=l9_248;
}
float4 l9_249=l9_211;
float3 l9_250=l9_249.xyz;
float3 l9_251=l9_250;
float3 l9_252=l9_209.xyz;
float3 l9_253=definedBlend(l9_251,l9_252,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_210=float4(l9_253.x,l9_253.y,l9_253.z,l9_210.w);
float3 l9_254=mix(l9_250,l9_210.xyz,float3(l9_209.w));
l9_210=float4(l9_254.x,l9_254.y,l9_254.z,l9_210.w);
l9_210.w=1.0;
float4 l9_255=l9_210;
param_11=l9_255;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_256=float4(in.varScreenPos.xyz,1.0);
param_11=l9_256;
}
else
{
...
float l9_258=fast::clamp(abs(l9_257.z),0.0,1.0);
float4 l9_259=float4(l9_258,1.0-l9_258,1.0,1.0);
param_11=l9_259;
}
else
{
float4 l9_260=param_11;
...
float4 l9_267=param_13;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_267.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_267;
return out;
}
} // FRAGMENT SHADER
