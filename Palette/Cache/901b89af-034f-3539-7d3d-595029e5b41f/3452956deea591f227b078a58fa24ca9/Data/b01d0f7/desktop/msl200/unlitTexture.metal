...
//sampler sampler baseTextureSmpSC 0:22
...
//texture texture2D baseTexture 0:4:0:22
...
//float3x3 baseTextureTransform 4432
//float4 baseTextureUvMinMax 4480
//float4 baseTextureBorderColor 4496
//float4 Color 4512
//float depthRef 4528
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTexture 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int baseTextureLayout 75 0
...
constant bool SC_USE_CLAMP_TO_BORDER_baseTexture [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_baseTexture [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_baseTexture [[function_constant(35)]];
...
constant bool baseTextureHasSwappedViews [[function_constant(38)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_baseTexture [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_baseTexture [[function_constant(73)]];
...
constant int baseTextureLayout [[function_constant(75)]];
...
texture2d<float> baseTexture [[id(4)]];
...
sampler baseTextureSmpSC [[id(22)]];
...
int l9_6=l9_1;
int param_1=baseTextureLayout_tmp;
int param_2=l9_6;
float2 param_3=Globals.Surface_UVCoord0;
bool param_4=(int(SC_USE_UV_TRANSFORM_baseTexture_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).baseTextureTransform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_baseTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTexture_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_baseTexture_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).baseTextureUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_baseTexture_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).baseTextureBorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.baseTexture.sample(sc_set0.baseTextureSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
float4 param_12=(*sc_set0.UserUniforms).Color;
Output_N0=param_12;
float4 Output_N1=float4(0.0);
Output_N1=Color_N3*Output_N0;
float Output_N5=0.0;
Output_N5=Output_N0.w;
float4 Value_N6=float4(0.0);
Value_N6=float4(Output_N1.xyz.x,Output_N1.xyz.y,Output_N1.xyz.z,Value_N6.w);
Value_N6.w=Output_N5;
FinalColor=Value_N6;
