...
let CropRegion = (() => {
    ...
    var CropRegion = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.cameraServiceObject = this.cameraServiceObject;
        ...
        onAwake() {
            this.cameraService = this.cameraServiceObject.getComponent("Component.ScriptComponent");
        ...
        update() {
            ...
            for (var i = 0; i < this.transformsToTrack.length; i++) {
                ...
                var isTrackingPoint = Math.abs(imagePos.x) <= 1 && Math.abs(imagePos.y) <= 1;
