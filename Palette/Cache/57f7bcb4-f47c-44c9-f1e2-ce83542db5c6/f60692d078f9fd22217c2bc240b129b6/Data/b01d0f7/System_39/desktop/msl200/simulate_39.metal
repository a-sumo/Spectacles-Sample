...
//sampler sampler colorMapSmpSC 0:23
//sampler sampler posMapSmpSC 0:25
//sampler sampler renderTarget0SmpSC 0:26
//sampler sampler renderTarget1SmpSC 0:27
//sampler sampler renderTarget2SmpSC 0:28
//sampler sampler renderTarget3SmpSC 0:29
//texture texture2D colorMap 0:0:0:23
//texture texture2D posMap 0:2:0:25
//texture texture2D renderTarget0 0:3:0:26
//texture texture2D renderTarget1 0:4:0:27
//texture texture2D renderTarget2 0:5:0:28
//texture texture2D renderTarget3 0:6:0:29
//ubo int UserUniforms 0:39:7664 {
//float4 sc_Time 1376
...
//float texSize 7648
//float Port_Value_N001 7652
//}
//spec_const bool SC_USE_CLAMP_TO_BORDER_colorMap 0 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_posMap 1 0
//spec_const bool SC_USE_UV_MIN_MAX_colorMap 2 0
//spec_const bool SC_USE_UV_MIN_MAX_posMap 3 0
//spec_const bool SC_USE_UV_TRANSFORM_colorMap 4 0
//spec_const bool SC_USE_UV_TRANSFORM_posMap 5 0
//spec_const bool colorMapHasSwappedViews 6 0
//spec_const bool posMapHasSwappedViews 7 0
//spec_const bool renderTarget0HasSwappedViews 8 0
//spec_const bool renderTarget1HasSwappedViews 9 0
//spec_const bool renderTarget2HasSwappedViews 10 0
//spec_const bool renderTarget3HasSwappedViews 11 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_colorMap 12 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_posMap 13 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_colorMap 14 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_posMap 15 -1
//spec_const int colorMapLayout 16 0
//spec_const int posMapLayout 17 0
//spec_const int renderTarget0Layout 18 0
//spec_const int renderTarget1Layout 19 0
//spec_const int renderTarget2Layout 20 0
//spec_const int renderTarget3Layout 21 0
...
constant bool SC_USE_CLAMP_TO_BORDER_posMap [[function_constant(1)]];
...
constant bool SC_USE_UV_MIN_MAX_colorMap [[function_constant(2)]];
...
constant bool SC_USE_UV_MIN_MAX_posMap [[function_constant(3)]];
...
constant bool SC_USE_UV_TRANSFORM_colorMap [[function_constant(4)]];
...
constant bool SC_USE_UV_TRANSFORM_posMap [[function_constant(5)]];
...
constant bool colorMapHasSwappedViews [[function_constant(6)]];
...
constant bool renderTarget1HasSwappedViews [[function_constant(9)]];
...
constant bool renderTarget2HasSwappedViews [[function_constant(10)]];
...
constant bool renderTarget3HasSwappedViews [[function_constant(11)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_colorMap [[function_constant(12)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_posMap [[function_constant(13)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_colorMap [[function_constant(14)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_posMap [[function_constant(15)]];
...
sampler colorMapSmpSC [[id(23)]];
sampler posMapSmpSC [[id(25)]];
sampler renderTarget0SmpSC [[id(26)]];
sampler renderTarget1SmpSC [[id(27)]];
sampler renderTarget2SmpSC [[id(28)]];
sampler renderTarget3SmpSC [[id(29)]];
...
gParticle.Size=(*sc_set0.UserUniforms).Port_Value_N001;
...
float3 Rotation_N0=float3(0.0);
float3 Scale_N0=float3(0.0);
int l9_13=gl_InstanceIndex;
float4x4 l9_14=(*sc_set0.UserUniforms).vfxModelMatrix[l9_13/32768];
float3 param_3=l9_14[3].xyz;
float3 param_5=float3(length(l9_14[0].xyz),length(l9_14[1].xyz),length(l9_14[2].xyz));
float3x3 l9_15=float3x3(float3(l9_14[0].xyz/float3(param_5.x)),float3(l9_14[1].xyz/float3(param_5.y)),float3(l9_14[2].xyz/float3(param_5.z)));
float l9_16=sqrt((l9_15[0].x*l9_15[0].x)+(l9_15[1].x*l9_15[1].x));
float3 param_4;
param_4.x=-atan2(l9_15[2].y,l9_15[2].z);
param_4.y=-atan2(-l9_15[2].x,l9_16);
param_4.z=-atan2(l9_15[1].x,l9_15[0].x);
param_4*=57.29578;
Position_N0=param_3;
Rotation_N0=param_4;
Scale_N0=param_5;
...
float3 param_7=Position_N0;
float3 param_8=Rotation_N0;
float3 param_9=Scale_N0;
...
float l9_18=l9_17;
float l9_19=N2_texSize*N2_texSize;
float l9_20=floor((l9_18*(l9_19-1.0))+0.5);
float l9_21=floor(l9_20/N2_texSize);
float l9_22=mod(l9_20,N2_texSize);
float l9_23=(l9_22+0.5)/N2_texSize;
float l9_24=(l9_21+0.5)/N2_texSize;
...
int l9_32=l9_27;
int l9_33=posMapLayout_tmp;
int l9_34=l9_32;
float2 l9_35=l9_25;
bool l9_36=(int(SC_USE_UV_TRANSFORM_posMap_tmp)!=0);
float3x3 l9_37=(*sc_set0.UserUniforms).posMapTransform;
int2 l9_38=int2(SC_SOFTWARE_WRAP_MODE_U_posMap_tmp,SC_SOFTWARE_WRAP_MODE_V_posMap_tmp);
bool l9_39=(int(SC_USE_UV_MIN_MAX_posMap_tmp)!=0);
float4 l9_40=(*sc_set0.UserUniforms).posMapUvMinMax;
bool l9_41=(int(SC_USE_CLAMP_TO_BORDER_posMap_tmp)!=0);
float4 l9_42=(*sc_set0.UserUniforms).posMapBorderColor;
float l9_43=0.0;
...
float4 l9_110=sc_set0.posMap.sample(sc_set0.posMapSmpSC,l9_109.xy,level(l9_103));
...
int l9_122=l9_117;
int l9_123=colorMapLayout_tmp;
int l9_124=l9_122;
float2 l9_125=l9_115;
bool l9_126=(int(SC_USE_UV_TRANSFORM_colorMap_tmp)!=0);
float3x3 l9_127=(*sc_set0.UserUniforms).colorMapTransform;
int2 l9_128=int2(SC_SOFTWARE_WRAP_MODE_U_colorMap_tmp,SC_SOFTWARE_WRAP_MODE_V_colorMap_tmp);
bool l9_129=(int(SC_USE_UV_MIN_MAX_colorMap_tmp)!=0);
float4 l9_130=(*sc_set0.UserUniforms).colorMapUvMinMax;
bool l9_131=(int(SC_USE_CLAMP_TO_BORDER_colorMap_tmp)!=0);
float4 l9_132=(*sc_set0.UserUniforms).colorMapBorderColor;
float l9_133=0.0;
...
float4 l9_200=sc_set0.colorMap.sample(sc_set0.colorMapSmpSC,l9_199.xy,level(l9_193));
...
float3 l9_205=float3(l9_114.x,l9_114.y,l9_114.z)-float3(0.5);
float3 l9_206=l9_205*N2_scale;
float3 l9_207=N2_rot*0.017453292;
float l9_208=cos(l9_207.x);
float l9_209=sin(l9_207.x);
float l9_210=cos(l9_207.y);
float l9_211=sin(l9_207.y);
float l9_212=cos(l9_207.z);
float l9_213=sin(l9_207.z);
float3 l9_214=float3((l9_206.x*l9_210)+(l9_206.z*l9_211),l9_206.y,((-l9_206.x)*l9_211)+(l9_206.z*l9_210));
float3 l9_215=float3(l9_214.x,(l9_214.y*l9_208)-(l9_214.z*l9_209),(l9_214.y*l9_209)+(l9_214.z*l9_208));
float3 l9_216=float3((l9_215.x*l9_212)-(l9_215.y*l9_213),(l9_215.x*l9_213)+(l9_215.y*l9_212),l9_215.z);
N2_particlePosition=l9_216+N2_pos;
N2_particleColor=float4(l9_204.x,l9_204.y,l9_204.z,1.0);
...
float4 l9_217=param_13;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_218=dot(l9_217,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_219=l9_218;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_219;
}
}
float4 l9_220=float4(param_13.x,-param_13.y,(param_13.z*0.5)+(param_13.w*0.5),param_13.w);
out.gl_Position=l9_220;
return out;
}
float l9_221;
...
{
l9_221=gParticle.Force.x;
}
gParticle.Force.x=l9_221;
float l9_222;
...
{
l9_222=gParticle.Force.y;
}
gParticle.Force.y=l9_222;
float l9_223;
...
{
l9_223=gParticle.Force.z;
}
gParticle.Force.z=l9_223;
...
{
l9_224=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_224;
float l9_225;
...
{
l9_225=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_225;
float l9_226;
...
{
l9_226=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_226;
...
float4 l9_229=param_14;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_230=dot(l9_229,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_231=l9_230;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_231;
}
}
float4 l9_232=float4(param_14.x,-param_14.y,(param_14.z*0.5)+(param_14.w*0.5),param_14.w);
out.gl_Position=l9_232;
...
float4 l9_233=param_15;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_234=dot(l9_233,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_235=l9_234;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_235;
}
}
float4 l9_236=float4(param_15.x,-param_15.y,(param_15.z*0.5)+(param_15.w*0.5),param_15.w);
out.gl_Position=l9_236;
return out;
}
return out;
}
