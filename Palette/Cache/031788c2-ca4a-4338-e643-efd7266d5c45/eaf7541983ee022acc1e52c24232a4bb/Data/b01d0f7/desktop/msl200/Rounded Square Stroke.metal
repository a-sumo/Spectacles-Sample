...
//float Port_size_N008 4384
//float Port_radius_N008 4388
//float Port_strokeWidth_N008 4392
//float4 Port_strokeColor_N008 4400
//float3 Port_surfaceWorldScale_N008 4416
//float2 Port_uvOffset_N008 4432
//float depthRef 4440
//}
...
float Port_size_N008;
float Port_radius_N008;
float Port_strokeWidth_N008;
float4 Port_strokeColor_N008;
float3 Port_surfaceWorldScale_N008;
float2 Port_uvOffset_N008;
float depthRef;
};
struct sc_Bone_t
{
...
float N8_size=0.0;
float N8_radius=0.0;
float N8_strokeWidth=0.0;
float4 N8_strokeColor=float4(0.0);
float2 N8_surfaceUVCoords=float2(0.0);
float3 N8_surfaceWorldScale=float3(0.0);
float2 N8_uvOffset=float2(0.0);
float4 N8_Output=float4(0.0);
...
float param_1=(*sc_set0.UserUniforms).Port_size_N008;
float param_2=(*sc_set0.UserUniforms).Port_radius_N008;
float param_3=(*sc_set0.UserUniforms).Port_strokeWidth_N008;
float4 param_4=(*sc_set0.UserUniforms).Port_strokeColor_N008;
float2 param_5=UVCoord_N0;
float3 param_6=(*sc_set0.UserUniforms).Port_surfaceWorldScale_N008;
float2 param_7=(*sc_set0.UserUniforms).Port_uvOffset_N008;
float4 param_8=float4(0.0);
N8_size=param_1;
N8_radius=param_2;
N8_strokeWidth=param_3;
N8_strokeColor=param_4;
N8_surfaceUVCoords=param_5;
N8_surfaceWorldScale=param_6;
N8_uvOffset=param_7;
float l9_1=N8_surfaceWorldScale.x/N8_surfaceWorldScale.y;
float2 l9_2=N8_surfaceUVCoords-N8_uvOffset;
float2 l9_3=float2(l9_2.x,l9_2.y/l9_1);
float l9_4=N8_size*0.5;
float2 l9_5=float2(l9_4,l9_4);
float2 l9_6=l9_3;
float2 l9_7=l9_5;
float l9_8=N8_radius;
...
float l9_13=l9_4-N8_strokeWidth;
float l9_14=fast::max(N8_radius-N8_strokeWidth,0.0);
float2 l9_15=float2(l9_13,l9_13);
float2 l9_16=l9_3;
float2 l9_17=l9_15;
float l9_18=l9_14;
float2 l9_19=(abs(l9_16)-l9_17)+float2(l9_18);
float l9_20=(length(fast::max(l9_19,float2(0.0)))+fast::min(fast::max(l9_19.x,l9_19.y),0.0))-l9_18;
float l9_21=l9_20;
float l9_22=step(l9_21,0.0);
float l9_23=l9_12-l9_22;
N8_Output=N8_strokeColor*l9_23;
param_8=N8_Output;
Output_N8=param_8;
...
float2 l9_25=floor(mod(l9_24.xy,float2(4.0)));
float l9_26=(mod(dot(l9_25,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_9<l9_26)
{
discard_fragment();
}
...
float4 l9_27=fast::max(param_10,float4(0.0));
float4 param_11=l9_27;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float l9_31=l9_30;
float l9_32=l9_31;
float l9_33=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_32;
float3 l9_34=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_28.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
float4 l9_36=param_12;
float4 l9_37=float4(0.0);
float4 l9_38=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_39=out.sc_FragData0;
l9_38=l9_39;
}
else
{
float4 l9_40=gl_FragCoord;
float2 l9_41=l9_40.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_42=l9_41;
...
int l9_46=l9_45;
int l9_47=l9_46;
float3 l9_48=float3(l9_42,0.0);
int l9_49=l9_44;
int l9_50=l9_47;
if (l9_49==1)
{
l9_48.y=((2.0*l9_48.y)+float(l9_50))-1.0;
}
float2 l9_51=l9_48.xy;
l9_43=l9_51;
}
else
{
...
int l9_62=l9_57;
float2 l9_63=l9_55;
int l9_64=sc_ScreenTextureLayout_tmp;
int l9_65=l9_62;
float l9_66=l9_56;
float2 l9_67=l9_63;
int l9_68=l9_64;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
float4 l9_75=l9_74;
l9_38=l9_75;
}
float4 l9_76=l9_38;
float3 l9_77=l9_76.xyz;
float3 l9_78=l9_77;
float3 l9_79=l9_36.xyz;
float3 l9_80=definedBlend(l9_78,l9_79,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_37=float4(l9_80.x,l9_80.y,l9_80.z,l9_37.w);
float3 l9_81=mix(l9_77,l9_37.xyz,float3(l9_36.w));
l9_37=float4(l9_81.x,l9_81.y,l9_81.z,l9_37.w);
l9_37.w=1.0;
float4 l9_82=l9_37;
param_12=l9_82;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_83=float4(in.varScreenPos.xyz,1.0);
param_12=l9_83;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_84=gl_FragCoord;
float l9_85=fast::clamp(abs(l9_84.z),0.0,1.0);
float4 l9_86=float4(l9_85,1.0-l9_85,1.0,1.0);
param_12=l9_86;
}
else
{
float4 l9_87=param_12;
float4 l9_88=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_88=float4(mix(float3(1.0),l9_87.xyz,float3(l9_87.w)),l9_87.w);
}
else
{
...
{
l9_89=fast::clamp(l9_89,0.0,1.0);
}
l9_88=float4(l9_87.xyz*l9_89,l9_89);
}
else
{
l9_88=l9_87;
...
float4 l9_94=param_14;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_94.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_94;
return out;
}
} // FRAGMENT SHADER
