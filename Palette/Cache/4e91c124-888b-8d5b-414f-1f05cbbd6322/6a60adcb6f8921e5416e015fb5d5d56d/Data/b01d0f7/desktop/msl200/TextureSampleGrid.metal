...
//texture texture2D mainTexture 0:5:0:23
...
//}
//ubo int UserUniforms 0:33:4704 {
//float4 sc_Time 1376
...
//float3x3 mainTextureTransform 4432
//float4 mainTextureUvMinMax 4480
//float4 mainTextureBorderColor 4496
//float gridScale 4512
//float4 Tweak_N34 4528
//float Port_Input0_N010 4544
//float Port_Input1_N023 4548
//float Port_radius_N011 4552
//float Port_strokeWidth_N011 4556
//float4 Port_fillColor_N011 4560
//float4 Port_strokeColor_N011 4576
//float2 Port_uvOffset_N011 4592
//float Port_strokeWidth_N029 4600
//float Port_softness_N029 4604
//float Port_feather_N029 4608
//float2 Port_uvOffset_N029 4616
//float2 Port_size_N027 4632
//float Port_radius_N027 4640
//float Port_strokeWidth_N027 4644
//float4 Port_fillColor_N027 4656
//float4 Port_strokeColor_N027 4672
//float2 Port_uvOffset_N027 4688
//float depthRef 4696
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTexture 74 -1
//spec_const int intensityTextureLayout 75 0
//spec_const int mainTextureLayout 76 0
...
constant bool SC_USE_CLAMP_TO_BORDER_mainTexture [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_mainTexture [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_mainTexture [[function_constant(36)]];
...
constant bool mainTextureHasSwappedViews [[function_constant(39)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_mainTexture [[function_constant(72)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_mainTexture [[function_constant(74)]];
...
constant int mainTextureLayout [[function_constant(76)]];
...
float Port_radius_N011;
float Port_strokeWidth_N011;
float4 Port_fillColor_N011;
float4 Port_strokeColor_N011;
float2 Port_uvOffset_N011;
float Port_strokeWidth_N029;
float Port_softness_N029;
float Port_feather_N029;
float2 Port_uvOffset_N029;
float Port_Mask_N014;
float Port_Mask_N005;
float2 Port_size_N027;
float Port_radius_N027;
float Port_strokeWidth_N027;
float4 Port_fillColor_N027;
float4 Port_strokeColor_N027;
float2 Port_uvOffset_N027;
float depthRef;
};
struct sc_Bone_t
{
...
texture2d<float> mainTexture [[id(5)]];
...
{
main_frag_out out={};
float2 N11_size=float2(0.0);
float N11_radius=0.0;
float N11_strokeWidth=0.0;
float4 N11_fillColor=float4(0.0);
float4 N11_strokeColor=float4(0.0);
float2 N11_surfaceUVCoords=float2(0.0);
float3 N11_surfaceWorldScale=float3(0.0);
float2 N11_uvOffset=float2(0.0);
float4 N11_Output=float4(0.0);
...
float2 N27_size=float2(0.0);
float N27_radius=0.0;
float N27_strokeWidth=0.0;
float4 N27_fillColor=float4(0.0);
float4 N27_strokeColor=float4(0.0);
float2 N27_surfaceUVCoords=float2(0.0);
float3 N27_surfaceWorldScale=float3(0.0);
float2 N27_uvOffset=float2(0.0);
float4 N27_Output=float4(0.0);
...
int l9_6=l9_1;
int param_1=mainTextureLayout_tmp;
int param_2=l9_6;
float2 param_3=Globals.Surface_UVCoord0;
bool param_4=(int(SC_USE_UV_TRANSFORM_mainTexture_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).mainTextureTransform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_mainTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTexture_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_mainTexture_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).mainTextureUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_mainTexture_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).mainTextureBorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.mainTexture.sample(sc_set0.mainTextureSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
Color_N12=l9_75;
float Output_N2=0.0;
float param_12=(*sc_set0.UserUniforms).gridScale;
Output_N2=param_12;
float Output_N10=0.0;
Output_N10=(*sc_set0.UserUniforms).Port_Input0_N010/(Output_N2+1.234e-06);
float Output_N23=0.0;
Output_N23=Output_N10*(*sc_set0.UserUniforms).Port_Input1_N023;
float2 UVCoord_N19=float2(0.0);
UVCoord_N19=Globals.Surface_UVCoord0;
float3 Scale_N31=float3(0.0);
float4x4 l9_76=(*sc_set0.UserUniforms).sc_ModelMatrix;
float3 param_13=float3(length(l9_76[0].xyz),length(l9_76[1].xyz),length(l9_76[2].xyz));
Scale_N31=param_13;
float4 Output_N11=float4(0.0);
float2 param_14=float2(Output_N23);
float param_15=(*sc_set0.UserUniforms).Port_radius_N011;
float param_16=(*sc_set0.UserUniforms).Port_strokeWidth_N011;
float4 param_17=(*sc_set0.UserUniforms).Port_fillColor_N011;
float4 param_18=(*sc_set0.UserUniforms).Port_strokeColor_N011;
float2 param_19=UVCoord_N19;
float3 param_20=Scale_N31;
float2 param_21=(*sc_set0.UserUniforms).Port_uvOffset_N011;
float4 param_22=float4(0.0);
N11_size=param_14;
N11_radius=param_15;
N11_strokeWidth=param_16;
N11_fillColor=param_17;
N11_strokeColor=param_18;
N11_surfaceUVCoords=param_19;
N11_surfaceWorldScale=param_20;
N11_uvOffset=param_21;
float l9_77=N11_surfaceWorldScale.x/N11_surfaceWorldScale.y;
float2 l9_78=N11_surfaceUVCoords-N11_uvOffset;
float2 l9_79=float2(l9_78.x,l9_78.y/l9_77);
float2 l9_80=N11_size*0.5;
float2 l9_81=l9_79;
float2 l9_82=l9_80;
float l9_83=N11_radius;
float2 l9_84=(abs(l9_81)-l9_82)+float2(l9_83);
float l9_85=(length(fast::max(l9_84,float2(0.0)))+fast::min(fast::max(l9_84.x,l9_84.y),0.0))-l9_83;
float l9_86=l9_85;
float l9_87=step(l9_86,0.0);
float2 l9_88=l9_80-float2(N11_strokeWidth);
float l9_89=fast::max(N11_radius-N11_strokeWidth,0.0);
float2 l9_90=l9_79;
float2 l9_91=l9_88;
float l9_92=l9_89;
float2 l9_93=(abs(l9_90)-l9_91)+float2(l9_92);
float l9_94=(length(fast::max(l9_93,float2(0.0)))+fast::min(fast::max(l9_93.x,l9_93.y),0.0))-l9_92;
float l9_95=l9_94;
float l9_96=step(l9_95,0.0);
float l9_97=l9_87-l9_96;
float l9_98=l9_96;
float4 l9_99=N11_fillColor*l9_98;
float4 l9_100=N11_strokeColor*l9_97;
N11_Output=l9_99+l9_100;
param_22=N11_Output;
Output_N11=param_22;
float4 Output_N34=float4(0.0);
float4 param_23=(*sc_set0.UserUniforms).Tweak_N34;
Output_N34=param_23;
float2 UVCoord_N8=float2(0.0);
UVCoord_N8=Globals.Surface_UVCoord0;
float3 Scale_N20=float3(0.0);
float4x4 l9_101=(*sc_set0.UserUniforms).sc_ModelMatrix;
float3 param_24=float3(length(l9_101[0].xyz),length(l9_101[1].xyz),length(l9_101[2].xyz));
Scale_N20=param_24;
float4 Output_N29=float4(0.0);
float param_25=Output_N2;
float param_26=Output_N2;
float param_27=(*sc_set0.UserUniforms).Port_strokeWidth_N029;
float param_28=(*sc_set0.UserUniforms).Port_softness_N029;
float param_29=(*sc_set0.UserUniforms).Port_feather_N029;
float4 param_30=Output_N34;
float2 param_31=UVCoord_N8;
float3 param_32=Scale_N20;
float2 param_33=(*sc_set0.UserUniforms).Port_uvOffset_N029;
float4 param_34=float4(0.0);
N29_gridCountX=param_25;
N29_gridCountY=param_26;
N29_strokeWidth=param_27;
N29_softness=param_28;
N29_feather=param_29;
N29_gridColor=param_30;
N29_surfaceUVCoords=param_31;
N29_surfaceWorldScale=param_32;
N29_uvOffset=param_33;
float l9_102=N29_surfaceWorldScale.x/N29_surfaceWorldScale.y;
float2 l9_103=N29_surfaceUVCoords-N29_uvOffset;
float2 l9_104=float2(l9_103.x,l9_103.y/l9_102);
float2 l9_105=l9_104+float2(0.5);
float l9_106=N29_strokeWidth*0.5;
float l9_107=0.0;
float l9_108=1.0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_108<=(N29_gridCountX-1.0))
{
float l9_109=l9_108/N29_gridCountX;
float l9_110=abs(l9_105.x-l9_109);
float l9_111=1.0-smoothstep(l9_106-N29_softness,(l9_106+N29_softness)+N29_feather,l9_110);
l9_107=fast::max(l9_107,l9_111);
l9_108+=1.0;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_112<=(N29_gridCountY-1.0))
{
float l9_113=l9_112/N29_gridCountY;
float l9_114=abs(l9_105.y-l9_113);
float l9_115=1.0-smoothstep(l9_106-N29_softness,(l9_106+N29_softness)+N29_feather,l9_114);
l9_107=fast::max(l9_107,l9_115);
l9_112+=1.0;
continue;
}
else
...
N29_Output=N29_gridColor*l9_107;
param_34=N29_Output;
Output_N29=param_34;
float4 Output_N14=float4(0.0);
float4 param_36=Output_N11;
float4 param_37=Output_N29;
float4 l9_116=param_36;
float4 l9_117=param_37;
float3 l9_118=l9_116.xyz*l9_116.w;
l9_116=float4(l9_118.x,l9_118.y,l9_118.z,l9_116.w);
float4 param_35=l9_116+(l9_117*(1.0-l9_116.w));
Output_N14=param_35;
float4 Output_N5=float4(0.0);
float4 param_39=Color_N12;
float4 param_40=Output_N14;
float4 l9_119=param_39;
float4 l9_120=param_40;
float3 l9_121=l9_119.xyz*l9_119.w;
l9_119=float4(l9_121.x,l9_121.y,l9_121.z,l9_119.w);
float4 param_38=float4(1.0)-((float4(1.0)-l9_120)*(float4(1.0)-l9_119));
Output_N5=param_38;
float2 UVCoord_N13=float2(0.0);
UVCoord_N13=Globals.Surface_UVCoord0;
float3 Scale_N30=float3(0.0);
float4x4 l9_122=(*sc_set0.UserUniforms).sc_ModelMatrix;
float3 param_41=float3(length(l9_122[0].xyz),length(l9_122[1].xyz),length(l9_122[2].xyz));
Scale_N30=param_41;
float4 Output_N27=float4(0.0);
float2 param_42=(*sc_set0.UserUniforms).Port_size_N027;
float param_43=(*sc_set0.UserUniforms).Port_radius_N027;
float param_44=(*sc_set0.UserUniforms).Port_strokeWidth_N027;
float4 param_45=(*sc_set0.UserUniforms).Port_fillColor_N027;
float4 param_46=(*sc_set0.UserUniforms).Port_strokeColor_N027;
float2 param_47=UVCoord_N13;
float3 param_48=Scale_N30;
float2 param_49=(*sc_set0.UserUniforms).Port_uvOffset_N027;
float4 param_50=float4(0.0);
N27_size=param_42;
N27_radius=param_43;
N27_strokeWidth=param_44;
N27_fillColor=param_45;
N27_strokeColor=param_46;
N27_surfaceUVCoords=param_47;
N27_surfaceWorldScale=param_48;
N27_uvOffset=param_49;
float l9_123=N27_surfaceWorldScale.x/N27_surfaceWorldScale.y;
float2 l9_124=N27_surfaceUVCoords-N27_uvOffset;
float2 l9_125=float2(l9_124.x,l9_124.y/l9_123);
float2 l9_126=N27_size*0.5;
float2 l9_127=l9_125;
float2 l9_128=l9_126;
float l9_129=N27_radius;
float2 l9_130=(abs(l9_127)-l9_128)+float2(l9_129);
float l9_131=(length(fast::max(l9_130,float2(0.0)))+fast::min(fast::max(l9_130.x,l9_130.y),0.0))-l9_129;
float l9_132=l9_131;
float l9_133=step(l9_132,0.0);
float2 l9_134=l9_126-float2(N27_strokeWidth);
float l9_135=fast::max(N27_radius-N27_strokeWidth,0.0);
float2 l9_136=l9_125;
float2 l9_137=l9_134;
float l9_138=l9_135;
float2 l9_139=(abs(l9_136)-l9_137)+float2(l9_138);
float l9_140=(length(fast::max(l9_139,float2(0.0)))+fast::min(fast::max(l9_139.x,l9_139.y),0.0))-l9_138;
float l9_141=l9_140;
float l9_142=step(l9_141,0.0);
float l9_143=l9_133-l9_142;
float l9_144=l9_142;
float4 l9_145=N27_fillColor*l9_144;
float4 l9_146=N27_strokeColor*l9_143;
N27_Output=l9_145+l9_146;
param_50=N27_Output;
Output_N27=param_50;
float Output_N17=0.0;
Output_N17=Output_N27.w;
float Output_N38=0.0;
Output_N38=1.0-Output_N17;
float4 Output_N18=float4(0.0);
Output_N18=mix(Output_N5,Output_N27,float4(Output_N38));
...
float2 l9_148=floor(mod(l9_147.xy,float2(4.0)));
float l9_149=(mod(dot(l9_148,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_51<l9_149)
{
discard_fragment();
}
...
float4 l9_150=fast::max(param_52,float4(0.0));
float4 param_53=l9_150;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_153=fast::clamp(l9_152.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_153=fast::clamp(dot(l9_152.xyz,float3(l9_152.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_153=(1.0-dot(l9_152.xyz,float3(0.33333001)))*l9_152.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_153=(1.0-fast::clamp(dot(l9_152.xyz,float3(1.0)),0.0,1.0))*l9_152.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_153=fast::clamp(dot(l9_152.xyz,float3(1.0)),0.0,1.0)*l9_152.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_153=fast::clamp(dot(l9_152.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_153=dot(l9_152.xyz,float3(0.33333001))*l9_152.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_153=1.0-fast::clamp(dot(l9_152.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_154=l9_153;
float l9_155=l9_154;
float l9_156=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_155;
float3 l9_157=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_151.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_158=float4(l9_157.x,l9_157.y,l9_157.z,l9_156);
param_54=l9_158;
}
else
{
...
{
float4 l9_159=param_54;
float4 l9_160=float4(0.0);
float4 l9_161=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_162=out.sc_FragData0;
l9_161=l9_162;
}
else
{
float4 l9_163=gl_FragCoord;
float2 l9_164=l9_163.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_169=l9_168;
int l9_170=l9_169;
float3 l9_171=float3(l9_165,0.0);
int l9_172=l9_167;
int l9_173=l9_170;
if (l9_172==1)
{
l9_171.y=((2.0*l9_171.y)+float(l9_173))-1.0;
}
...
int l9_185=l9_180;
float2 l9_186=l9_178;
int l9_187=sc_ScreenTextureLayout_tmp;
int l9_188=l9_185;
float l9_189=l9_179;
...
float4 l9_196=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_195.xy,bias(l9_189));
float4 l9_197=l9_196;
float4 l9_198=l9_197;
l9_161=l9_198;
}
float4 l9_199=l9_161;
float3 l9_200=l9_199.xyz;
float3 l9_201=l9_200;
float3 l9_202=l9_159.xyz;
float3 l9_203=definedBlend(l9_201,l9_202,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_160=float4(l9_203.x,l9_203.y,l9_203.z,l9_160.w);
float3 l9_204=mix(l9_200,l9_160.xyz,float3(l9_159.w));
l9_160=float4(l9_204.x,l9_204.y,l9_204.z,l9_160.w);
l9_160.w=1.0;
float4 l9_205=l9_160;
param_54=l9_205;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_206=float4(in.varScreenPos.xyz,1.0);
param_54=l9_206;
}
else
{
...
float l9_208=fast::clamp(abs(l9_207.z),0.0,1.0);
float4 l9_209=float4(l9_208,1.0-l9_208,1.0,1.0);
param_54=l9_209;
}
else
{
float4 l9_210=param_54;
float4 l9_211=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_211=float4(mix(float3(1.0),l9_210.xyz,float3(l9_210.w)),l9_210.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_212=l9_210.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_212=fast::clamp(l9_212,0.0,1.0);
}
l9_211=float4(l9_210.xyz*l9_212,l9_212);
}
else
{
l9_211=l9_210;
