...
//float gridWidth 7392
//float gridHeight 7396
//float Port_Value_N008 7404
//}
...
l9_42=!(UserUniforms.vfxBatchEnable[l9_43/32]!=0);
}
else
{
l9_42=l9_41;
...
main_vert_out out={};
int ssInstanceID=0;
float N2_gridWidth=0.0;
float N2_gridHeight=0.0;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/32];
...
gParticle.Size=(*sc_set0.UserUniforms).Port_Value_N008;
...
float Output_N3=0.0;
float param_2=(*sc_set0.UserUniforms).gridWidth;
Output_N3=param_2;
float Output_N4=0.0;
float param_3=(*sc_set0.UserUniforms).gridHeight;
Output_N4=param_3;
float3 Position_N6=float3(0.0);
float3 Rotation_N6=float3(0.0);
float3 Scale_N6=float3(0.0);
int l9_13=gl_InstanceIndex;
float4x4 l9_14=(*sc_set0.UserUniforms).vfxModelMatrix[l9_13/32];
...
float param_8=Output_N4;
float3 param_9=Position_N6;
float3 param_10=Rotation_N6;
float3 param_11=Scale_N6;
float3 param_12=float3(0.0);
float4 param_13=float4(0.0);
N2_gridWidth=param_7;
N2_gridHeight=param_8;
N2_pos=param_9;
N2_rot=param_10;
N2_scale=param_11;
float l9_17=fast::max(N2_gridWidth,1.0);
float l9_18=fast::max(N2_gridHeight,1.0);
float l9_19=l9_17*l9_18;
float l9_20=gParticle.Ratio1DPerCopy;
float l9_21=l9_20;
float l9_22=floor((l9_21*(l9_19-1.0))+0.5);
float l9_23=mod(l9_22,l9_17);
float l9_24=floor(l9_22/l9_17);
float l9_25=(l9_17-1.0)*0.5;
float l9_26=(l9_18-1.0)*0.5;
float3 l9_27=float3((l9_23-l9_25)/fast::max(l9_17-1.0,1.0),0.0,(l9_24-l9_26)/fast::max(l9_18-1.0,1.0));
float3 l9_28=l9_27*N2_scale;
float3 l9_29=N2_rot*0.017453292;
float l9_30=cos(l9_29.x);
float l9_31=sin(l9_29.x);
float l9_32=cos(l9_29.y);
float l9_33=sin(l9_29.y);
float l9_34=cos(l9_29.z);
float l9_35=sin(l9_29.z);
float3 l9_36=float3((l9_28.x*l9_32)+(l9_28.z*l9_33),l9_28.y,((-l9_28.x)*l9_33)+(l9_28.z*l9_32));
float3 l9_37=float3(l9_36.x,(l9_36.y*l9_30)-(l9_36.z*l9_31),(l9_36.y*l9_31)+(l9_36.z*l9_30));
float3 l9_38=float3((l9_37.x*l9_34)-(l9_37.y*l9_35),(l9_37.x*l9_35)+(l9_37.y*l9_34),l9_37.z);
N2_particlePosition=l9_38+N2_pos;
float l9_39=l9_23/fast::max(l9_17-1.0,1.0);
float l9_40=l9_24/fast::max(l9_18-1.0,1.0);
N2_particleColor=float4(l9_39,0.5,l9_40,1.0);
param_12=N2_particlePosition;
param_13=N2_particleColor;
particlePosition_N2=param_12;
particleColor_N2=param_13;
gParticle.Position=particlePosition_N2;
gParticle.Color=particleColor_N2;
float3x3 param_14=gParticle.Matrix;
gParticle.Quaternion=matrixToQuaternion(param_14);
...
float4 l9_44=float4(param_15.x,-param_15.y,(param_15.z*0.5)+(param_15.w*0.5),param_15.w);
...
{
l9_45=gParticle.Force.x;
}
gParticle.Force.x=l9_45;
float l9_46;
...
{
l9_46=gParticle.Force.y;
}
gParticle.Force.y=l9_46;
float l9_47;
...
{
l9_47=gParticle.Force.z;
}
gParticle.Force.z=l9_47;
...
{
l9_48=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_48;
float l9_49;
...
{
l9_49=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_49;
float l9_50;
...
{
l9_50=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_50;
...
Vertex.y=l9_52;
Vertex+=Offset;
float4 param_16=float4((Vertex*2.0)-float2(1.0),1.0,1.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_53=param_16;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_54=dot(l9_53,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_55=l9_54;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_55;
}
}
float4 l9_56=float4(param_16.x,-param_16.y,(param_16.z*0.5)+(param_16.w*0.5),param_16.w);
out.gl_Position=l9_56;
...
float4 l9_57=param_17;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_58=dot(l9_57,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_59=l9_58;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_59;
}
}
float4 l9_60=float4(param_17.x,-param_17.y,(param_17.z*0.5)+(param_17.w*0.5),param_17.w);
out.gl_Position=l9_60;
return out;
}
return out;
}
