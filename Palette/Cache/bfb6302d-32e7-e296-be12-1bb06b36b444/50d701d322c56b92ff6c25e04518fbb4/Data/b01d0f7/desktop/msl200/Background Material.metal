...
//float4 Tweak_N3 4384
//float Port_Input1_N006 4400
//float Port_radius_N001 4404
//float Port_strokeWidth_N001 4408
//float4 Port_strokeColor_N001 4416
//float2 Port_uvOffset_N001 4432
//float depthRef 4440
//}
...
float Port_radius_N001;
float Port_strokeWidth_N001;
float4 Port_strokeColor_N001;
float2 Port_uvOffset_N001;
float depthRef;
};
struct sc_Bone_t
{
...
{
main_frag_out out={};
float2 N1_size=float2(0.0);
float N1_radius=0.0;
float N1_strokeWidth=0.0;
float4 N1_fillColor=float4(0.0);
float4 N1_strokeColor=float4(0.0);
float2 N1_surfaceUVCoords=float2(0.0);
float3 N1_surfaceWorldScale=float3(0.0);
float2 N1_uvOffset=float2(0.0);
float4 N1_Output=float4(0.0);
...
float3 param_2=Scale_N2;
float l9_2=dot(param_2,param_2);
float l9_3;
if (l9_2>0.0)
{
l9_3=1.0/sqrt(l9_2);
...
float l9_4=l9_3;
float3 param_3=param_2*l9_4;
Output_N5=param_3;
float3 Output_N6=float3(0.0);
Output_N6=Output_N5*float3((*sc_set0.UserUniforms).Port_Input1_N006);
float4 Output_N3=float4(0.0);
float4 param_4=(*sc_set0.UserUniforms).Tweak_N3;
Output_N3=param_4;
float2 UVCoord_N0=float2(0.0);
UVCoord_N0=Globals.Surface_UVCoord0;
float4 Output_N1=float4(0.0);
float2 param_5=Output_N6.xy;
float param_6=(*sc_set0.UserUniforms).Port_radius_N001;
float param_7=(*sc_set0.UserUniforms).Port_strokeWidth_N001;
float4 param_8=Output_N3;
float4 param_9=(*sc_set0.UserUniforms).Port_strokeColor_N001;
float2 param_10=UVCoord_N0;
float3 param_11=Scale_N2;
float2 param_12=(*sc_set0.UserUniforms).Port_uvOffset_N001;
float4 param_13=float4(0.0);
N1_size=param_5;
N1_radius=param_6;
N1_strokeWidth=param_7;
N1_fillColor=param_8;
N1_strokeColor=param_9;
N1_surfaceUVCoords=param_10;
N1_surfaceWorldScale=param_11;
N1_uvOffset=param_12;
float l9_5=N1_surfaceWorldScale.x/N1_surfaceWorldScale.y;
float2 l9_6=N1_surfaceUVCoords-N1_uvOffset;
float2 l9_7=float2(l9_6.x,l9_6.y/l9_5);
float2 l9_8=N1_size*0.5;
float2 l9_9=l9_7;
float2 l9_10=l9_8;
float l9_11=N1_radius;
float2 l9_12=(abs(l9_9)-l9_10)+float2(l9_11);
float l9_13=(length(fast::max(l9_12,float2(0.0)))+fast::min(fast::max(l9_12.x,l9_12.y),0.0))-l9_11;
float l9_14=l9_13;
float l9_15=step(l9_14,0.0);
float2 l9_16=l9_8-float2(N1_strokeWidth);
float l9_17=fast::max(N1_radius-N1_strokeWidth,0.0);
float2 l9_18=l9_7;
float2 l9_19=l9_16;
float l9_20=l9_17;
...
float l9_23=l9_22;
float l9_24=step(l9_23,0.0);
float l9_25=l9_15-l9_24;
float l9_26=l9_24;
float4 l9_27=N1_fillColor*l9_26;
float4 l9_28=N1_strokeColor*l9_25;
N1_Output=l9_27+l9_28;
param_13=N1_Output;
Output_N1=param_13;
...
float4 l9_32=fast::max(param_15,float4(0.0));
float4 param_16=l9_32;
if (sc_ShaderCacheConstant_tmp!=0)
{
