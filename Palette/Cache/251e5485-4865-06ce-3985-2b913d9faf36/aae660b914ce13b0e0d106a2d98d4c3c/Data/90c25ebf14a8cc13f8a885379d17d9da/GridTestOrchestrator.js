...
exports.GridTestOrchestrator = void 0;
var __selfType = requireType("./GridTestOrchestrator");
...
let GridTestOrchestrator = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var GridTestOrchestrator = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.gridSync = this.gridSync;
        ...
        onUpdate(e) {
            if (!this.sync || !this.autoToggleEnabled || this.autoToggleInterval <= 0)
                return;
        ...
        toParticles() {
            if (this.sync) {
                ...
                if (this.debugMode)
                    print("GridTestOrchestrator: -> PARTICLE");
            }
        }
        /**
        ...
        toCircle() {
            if (this.sync) {
                ...
                if (this.debugMode)
                    print("GridTestOrchestrator: -> CIRCLE");
            }
        }
        /**
         * Enable/disable auto-toggle
         */
        setAutoToggle(enabled) {
            this.autoToggleEnabled = enabled;
            this.timer = this.autoToggleInterval;
            if (this.debugMode)
                print(`GridTestOrchestrator: Auto-toggle ${enabled ? "ON" : "OFF"}`);
        }
        /**
    ...
    __setFunctionName(_classThis, "GridTestOrchestrator");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        GridTestOrchestrator = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return GridTestOrchestrator = _classThis;
})();
exports.GridTestOrchestrator = GridTestOrchestrator;
//# sourceMappingURL=GridTestOrchestrator.js.map