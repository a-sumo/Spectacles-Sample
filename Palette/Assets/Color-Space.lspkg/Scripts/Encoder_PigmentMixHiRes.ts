...
@component
export class Encoder_PigmentMixHiRes extends BaseScriptComponent {
    
    @input
    @hint("Material with Encoder_PigmentMixHiRes shader")
    ...
    onAwake(): void {
        ...
        this.pigmentTexture = ProceduralTextureProvider.createWithFormat(
            Encoder_PigmentMixHiRes.NUM_PIGMENTS,
            1,
    ...
    private updatePigmentTexture(): void {
        ...
        (this.pigmentTexture.control as ProceduralTextureProvider).setPixels(
            0, 0, Encoder_PigmentMixHiRes.NUM_PIGMENTS, 1, pixels
        );
    }
